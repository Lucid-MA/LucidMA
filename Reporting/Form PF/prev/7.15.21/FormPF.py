...
change DCGX CUSIP to 262006208
change to PF-AMEND (if making multiple versions)
...
For a new filing, please initialize the date in line 61 (init_filing("PF-UPDATING", "Q", "2021-06-30", "1")
"""
...
# NEED TO CHANGE THIS
WORKBOOK_PATH = "S:\\Mandates\\Funds\\Record Keeping\\Form PF working files\\7.15.21\\Lucid Form PF Q1 2021 7.15.21 Draft 2 without M1.xlsx"
...
SECTION_1B_SHEETS = ["Section 1b - Priv Fnd USG M", "Section 1b - Prv Fnd Prime M",
                     ...
                     'Section 1b - Prv Fnd Prime MIG', #'Section 1b - Prv Fnd Prime M1',
...
SECTION_3_SHEETS1 = ["Sec 3 Item A-C USG M",     "Sec 3 Item A-C Prime M",
                     ...
                     "Sec 3 Item A-C Prime MIG", #"Sec 3 Item A-C Prime M1",
...
SECTION_3_SHEETS2 = ["Sec 3 Item D-E USG M",     "Sec 3 Item D-E Prime M",
                     ...
                     "Sec 3 Item D-E Prime MIG", #"Sec 3 Item D-E Prime M1",
                     "Sec 3 Item D-E Prime QX"]
Q63_PATHS = ["S:\\Mandates\\Funds\\Record Keeping\\Form PF working Files\\Q63\\curr\\2021_4_5_6_Prime_Custom1.xlsx",
             "S:\\Mandates\\Funds\\Record Keeping\\Form PF working Files\\Q63\\curr\\2021_4_5_6_Prime_Monthly.xlsx",
             "S:\\Mandates\\Funds\\Record Keeping\\Form PF working Files\\Q63\\curr\\2021_4_5_6_Prime_MonthlyIG.xlsx",
             "S:\\Mandates\\Funds\\Record Keeping\\Form PF working Files\\Q63\\curr\\2021_4_5_6_Prime_Quarterly1.xlsx",
             "S:\\Mandates\\Funds\\Record Keeping\\Form PF working Files\\Q63\\curr\\2021_4_5_6_Prime_QuarterlyX.xlsx",
             "S:\\Mandates\\Funds\\Record Keeping\\Form PF working Files\\Q63\\curr\\2021_4_5_6_USG_Monthly.xlsx"]

NA = -2146826246

FUND_DATA = (("Lucid Prime Fund LLC (Series C1)", "805-3531452546", "LIQUIDITY"),
             ("Lucid Prime Fund LLC (Series M)", "805-2462468395", "LIQUIDITY"),
             #("Lucid Prime Fund LLC (Series M1)", "805-6928118182", "LIQUIDITY"),
...
def main():
    ...
    init_filing("PF-UPDATING", "Q", "2021-06-30", "1")
    section1a_ItemA(wb)
    section1a_itemB(wb)
    section1a_itemC(wb)
    section1b_itemA(wb)
    ...
    tree.write("full_output.xml", encoding = "iso-8859-1", xml_declaration=True) #if they encoding type, check if it is utf-8
...
def section1b_itemC(wb):
    ...
    for sheet_name in SECTION_1B_SHEETS:
        ...
        row_start = 96
        for x in range (1, 13):
            if sheet.Range("C" + str(row_start)).Value == None:
                if x % 3 == 0:
                    row_start += 2
                else:
                    row_start += 1
...
def section3_itemE():
    ...
    for path in Q63_PATHS:
        ...
        while sheet.Range("A" + str(index)).Value is not None:
            ...
            ET.SubElement(security, "CUSIP").text = "NA" if sheet.Range("G" + str(index)).Value == NA else sheet.Range("G" + str(index)).Value
            ET.SubElement(security, "ISINNumber").text = "NA" if sheet.Range("H" + str(index)).Value == NA else sheet.Range("H" + str(index)).Value
