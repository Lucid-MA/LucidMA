...
import \
    win32com.client as win32  # might need pywin32 version 224... pip install --upgrade pywin32==224 and clear out the gen_py folder
...
XML_OUTPUT_PATH = "S:\\Mandates\\Funds\\Fund Reporting\\Form PF working files\\2024\\01.15.24\\lucid_form_pf_" + datetime.now().strftime("%Y%m%d_%H_%M_%S") + ".xml"
...
Q63_PATHS = ["S:\\Mandates\\Funds\\Fund Reporting\\Form PF working files\\2024\\01.15.24\\2023_10_11_12_Prime_Custom1.xlsx",
...
if DOING_HEDGE:
    ...
    FUND_DATA.append(["Lucid Prime Fund LLC [Series 2YIG]", "805-8312373461", "PRIVATE"])
...
def section1a_itemC(wb):
    ...
    while q_n != None:
        ...
        if warn and len(q_n) > 15:
            print("WARNING: Question number response too long. Max length is 15. Value is: " + q_n)
        ET.SubElement(new_misc_item, "Description").text =  sheet.Range("C" + str(curr_row)).Value
        curr_row = curr_row + 1
        q_n = sheet.Range("B" + str(curr_row)).Value
