...
import pandas as pd
from sqlalchemy import Table, MetaData, Column, String, Date, inspect
...
directory = r"S:/Lucid/Data/Bond Data/Historical"
# Get the repository root directory
repo_path = get_repo_root()
bronze_tracker_dir = repo_path / "Reporting" / "Bronze_tables" / "File_trackers"

processed_files_tracker =(bronze_tracker_dir / "Bronze Table Processed Daily Factor Data")
...
# SQLAlchemy Engine
engine = engine_prod if PUBLISH_TO_PROD else None  # Replace with your staging engine if needed
...
def initialize_table(table_name):
    ...
    table = Table(
        ...
        Column("CUSIP", String),
        Column("SECURITY_TYP", String),
        Column("ISSUER", String),
        Column("MTG Factor", String),
        Column("Int Acc", String),
...
def extract_date_from_filename(filename):
    ...
    if date_match:
        return datetime.strptime(date_match.group(), "%m_%d_%Y")
    return None
