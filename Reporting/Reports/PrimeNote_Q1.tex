...
{\color[HTML]{FFFFFF} \textbf{Current Target Return of Notes}\textsuperscript{1}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{3m SOFR + 70-72 bps}}\\
{\color[HTML]{FFFFFF} \textbf{Previous Coupon Period}} & January 18 - April 18 & \textbf{6.00\%} (3m SOFR + 70 bps) \\
{\color[HTML]{FFFFFF} \textbf{Current Period Est'd Coupon}\textsuperscript{2}} & April 18 - July 18 & \textbf{6.03\%}  (3m SOFR + 70 bps) \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
\end{center}
...
{\color[HTML]{FFFFFF}} & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}                & {\color[HTML]{FFFFFF} Spread}               & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}        & {\color[HTML]{FFFFFF} Spread}        & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}       & {\color[HTML]{FFFFFF} Spread}       \\ \arrayrulecolor{light_grey}\hline
	...
	\textbf{Lucid Prime - Series Q1-2}                    & \textbf{6.00\%}                              & \textbf{-}                                  & \textbf{6.11\%}                               & \textbf{-}                           & \textbf{6.11\%}                             & \textbf{-}                          \\
3m SOFR                       & 5.30\%                                       & \textbf{+70 bps}                            & 5.39\%                               & \textbf{+72 bps}                     & 5.35\%                              & \textbf{+76 bps}                    \\
3m A1/P1 CP                       & 5.33\%                                       & \textbf{+67 bps}                           & 5.45\%                               & \textbf{+66 bps}                     & 5.36\%                              & \textbf{+75 bps}                    \\
3m T-Bill                       & 5.25\%                                       & \textbf{+75 bps}                            & 5.36\%                               & \textbf{+75 bps}                     & 5.31\%                              & \textbf{+80 bps}                    \\ \arrayrulecolor{light_grey}\hline
...
\adjustbox{valign=t}{\begin{minipage}[t]{15cm}
		...
		US Govt/AAA Repo & 24.9\% & 113.5\% \\
		IG Repo: AA to A & 26.3\% & 121.3\% \\
		IG Repo: BBB & 35.3\% & 132.9\% \\
		Repo: BB & - & - \\
		T-Bills; Gov't MMF & 13.5\% & - \\ \cline{2-2} \cline{3-3} 
		\textbf{Total} & 100.0\% & \textbf{123.8\%} \\\arrayrulecolor{light_grey}\hline
		\end{tabular}
...
{\color[HTML]{FFFFFF} \textbf{Current Principal}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{\$451.8 million}} \\
...
{\color[HTML]{FFFFFF} \textbf{Next Notice Date for Redemption}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}July 03, 2024} \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
\end{center}
...
10/19/23 &\textbf{01/18/24} &\textbf{6.10\%} &3m SOFR+70 &\$451,750,000 &\$6,965,734.03 &01/18/24 &\$451,750,000 &126.97\% \\
01/18/24 &\textbf{04/18/24} &\textbf{6.00\%} &3m SOFR+70 &\$451,750,000 &\$6,851,541.67 &04/18/24 &\$451,750,000 &124.66\% \\
04/18/24 &\textbf{07/18/24} &\textbf{6.03\%{\tiny (Est'd)}} &3m SOFR+70 &\$451,750,000 &n/a &07/18/24 &\$451,750,000 &n/a \\
