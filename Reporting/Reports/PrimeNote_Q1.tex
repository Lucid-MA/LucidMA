...
\textbf{Lucid Prime Series Q1-2 / Note Series Q1-2}
} \\
...
{\color[HTML]{FFFFFF} \textbf{Current Target Return of Notes}\textsuperscript{1}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{3m SOFR + 66-68 bps}}\\
{\color[HTML]{FFFFFF} \textbf{Previous Coupon Period}} & April 18 - July 18 & \textbf{6.03\%} (3m SOFR + 70 bps) \\
{\color[HTML]{FFFFFF} \textbf{Current Period Est'd Coupon}\textsuperscript{2}} & July 18 - October 17 & \textbf{5.95\%}  (3m SOFR + 67 bps) \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
\end{center}
...
{\color[HTML]{FFFFFF}} & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}                & {\color[HTML]{FFFFFF} Spread}               & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}        & {\color[HTML]{FFFFFF} Spread}        & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}       & {\color[HTML]{FFFFFF} Spread}       \\ \arrayrulecolor{light_grey}\hline
	...
	\textbf{Lucid Prime - Series Q1-2}                    & \textbf{6.03\%}                              & \textbf{-}                                  & \textbf{6.06\%}                               & \textbf{-}                           & \textbf{6.18\%}                             & \textbf{-}                          \\
3m SOFR                       & 5.33\%                                       & \textbf{+70 bps}                            & 5.35\%                               & \textbf{+71 bps}                     & 5.45\%                              & \textbf{+73 bps}                    \\
3m A1/P1 CP                       & 5.38\%                                       & \textbf{+65 bps}                           & 5.39\%                               & \textbf{+67 bps}                     & 5.50\%                              & \textbf{+68 bps}                    \\
3m T-Bill                       & 5.20\%                                       & \textbf{+83 bps}                            & 5.26\%                               & \textbf{+80 bps}                     & 5.40\%                              & \textbf{+78 bps}                    \\ \arrayrulecolor{light_grey}\hline
...
\end{tabular}
	...
	\begin{axis}[
		...
		ymin=3, ymax=7.03, %MAXRETURN HERE
	   symbolic x coords={Series Q1-2,3m SOFR,3m A1/P1 CP,3m T-Bill},
		xtick={Series Q1-2,3m SOFR,3m A1/P1 CP,3m T-Bill},
...
\adjustbox{valign=t}{\begin{minipage}[t]{15cm}
		...
		\multicolumn{3}{!{\color{light_grey}\vrule}p{8.2cm}!{\color{light_grey}\vrule}}{\rowcolor[HTML]{EFEFEF}{\textbf{Series Q1}: Secured by \textbf{Investment Grade Collateral securities only}, with daily valuations \& margining.}} \\
		& & \\
		 & \textbf{\% Portfolio} & \textbf{O/C Rate}\\
		US Govt/AAA Repo & 26.9\% & 118.5\% \\
		IG Repo: AA to A & 27.5\% & 120.2\% \\
		IG Repo: BBB & 34.0\% & 131.5\% \\
		Repo: BB & - & - \\
		T-Bills; Gov't MMF & 11.6\% & - \\ \cline{2-2} \cline{3-3} 
		\textbf{Total} & 100.0\% & \textbf{124.0\%} \\\arrayrulecolor{light_grey}\hline
		\end{tabular}
...
\textbf{Related Fund Series Size} & \textbf{\$497.7 million} & Issuing \& Paying Agent & Bank of NY Mellon \\ 
...
\textbf{Q1-2} (Secured by related fund series Q1-2)
} \\
{\color[HTML]{FFFFFF} \textbf{Current Principal}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{\$251.8 million}} \\
{\color[HTML]{FFFFFF} \textbf{Original Issue Date}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}April 04, 2023} \\
{\color[HTML]{FFFFFF} \textbf{Final Maturity Date}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}April 27, 2026} \\
...
{\color[HTML]{FFFFFF} \textbf{Next Notice Date for Redemption}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}October 02, 2024} \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
\end{center}
...
10/19/23 &\textbf{01/18/24} &\textbf{6.10\%} &3m SOFR+70 &\$351,750,000 &\$5,423,789.58 &01/18/24 &\$351,750,000 &127.3\% \\
01/18/24 &\textbf{04/18/24} &\textbf{6.00\%} &3m SOFR+70 &\$391,750,000 &\$5,941,541.67 &04/18/24 &\$391,750,000 &125.4\% \\
04/18/24 &\textbf{07/18/24} &\textbf{6.03\%} &3m SOFR+70 &\$251,750,000 &\$6,885,799.38 &07/18/24 &\$251,750,000 &124.0\% \\
07/18/24 &\textbf{10/17/24} &\textbf{5.95\%{\tiny (Est'd)}} &3m SOFR+67 &\$251,750,000 &n/a &10/17/24 &\$251,750,000 &n/a \\
