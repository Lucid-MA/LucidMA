...
\adjustbox{valign=t}{\begin{minipage}[t]{15cm}
		...
		US Govt/AAA Repo & 17.7\% & 114.4\% \\
		IG Repo: AA to A & 23.9\% & 120.8\% \\
		IG Repo: BBB & 45.7\% & 130.6\% \\
		Repo: BB & - & - \\
		T-Bills; Gov't MMF & 12.8\% & - \\ \cline{2-2} \cline{3-3} 
		\textbf{Total} & 100.0\% & \textbf{124.7\%} \\\arrayrulecolor{light_grey}\hline
		\end{tabular}
...
\textbf{Related Fund Series Size} & \textbf{\$646.9 million} & Issuing \& Paying Agent & Bank of NY Mellon \\ 
...
{\color[HTML]{FFFFFF} \textbf{Current Principal}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{\$391.8 million}} \\
