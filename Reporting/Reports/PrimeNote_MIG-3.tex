...
{\color[HTML]{FFFFFF} \textbf{Current Target Return of Notes}\textsuperscript{1}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{1m SOFR + 60-62 bps}}\\
{\color[HTML]{FFFFFF} \textbf{Previous Coupon Period}} & Apr 18 - May 16 & \textbf{5.92\%} (1m SOFR + 60 bps) \\
{\color[HTML]{FFFFFF} \textbf{Current Period Est'd Coupon}\textsuperscript{2}} & May 16 - Jun 13 & \textbf{5.92\%}  (1m SOFR + 60 bps) \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
\end{center}
...
{\color[HTML]{FFFFFF}} & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}                & {\color[HTML]{FFFFFF} Spread}               & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}        & {\color[HTML]{FFFFFF} Spread}        & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}       & {\color[HTML]{FFFFFF} Spread}       \\ \arrayrulecolor{light_grey}\hline
	...
	\textbf{Lucid Prime - Series MIG}                    & \textbf{5.92\%}                              & \textbf{-}                                  & \textbf{5.91\%}                               & \textbf{-}                           & \textbf{n/a}                             & \textbf{-}                          \\
1m SOFR                       & 5.32\%                                       & \textbf{+60 bps}                            & 5.35\%                               & \textbf{+56 bps}                     & n/a                              & \textbf{n/a}                    \\
1m A1/P1 CP                       & 5.33\%                                       & \textbf{+59 bps}                           & 5.35\%                               & \textbf{+56 bps}                     & n/a                              & \textbf{n/a}                    \\
1m T-Bills                       & 5.30\%                                       & \textbf{+62 bps}                            & 5.32\%                               & \textbf{+59 bps}                     & n/a                              & \textbf{n/a}                    \\ \arrayrulecolor{light_grey}\hline
...
\adjustbox{valign=t}{\begin{minipage}[t]{15cm}
		...
		Repo: BB & - & - \\
		T-Bills; Gov't MMF & 6.0\% & - \\ \cline{2-2} \cline{3-3} 
		\textbf{Total} & 100.0\% & \textbf{125.0\%} \\\arrayrulecolor{light_grey}\hline
		\end{tabular}
...
{\color[HTML]{FFFFFF} \textbf{Current Principal}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{\$339.8 million}} \\
