...
{\color[HTML]{FFFFFF} \textbf{Previous Coupon Period}} & July 18 - August 15 & \textbf{5.810\%} (1m SOFR + 48 bps) \\
{\color[HTML]{FFFFFF} \textbf{Current Period Est'd Coupon}\textsuperscript{2}} & August 15 - September 12 & \textbf{5.817\%}  (1m SOFR + 48 bps) \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
\end{center}
...
{\color[HTML]{FFFFFF}} & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}                & {\color[HTML]{FFFFFF} Spread}               & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}        & {\color[HTML]{FFFFFF} Spread}        & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}       & {\color[HTML]{FFFFFF} Spread}       \\ \arrayrulecolor{light_grey}\hline
	...
	\textbf{Lucid Prime - Series M}                    & \textbf{5.81\%}                              & \textbf{-}                                  & \textbf{5.84\%}                               & \textbf{-}                           & \textbf{5.99\%}                             & \textbf{-}                          \\
1m SOFR                       & 5.33\%                                       & \textbf{+48 bps}                            & 5.35\%                               & \textbf{+49 bps}                     & 5.46\%                              & \textbf{+53 bps}                    \\
1m A1/P1 CP                       & 5.32\%                                       & \textbf{+49 bps}                           & 5.34\%                               & \textbf{+50 bps}                     & 5.45\%                              & \textbf{+54 bps}                    \\
1m T-Bill                       & 5.26\%                                       & \textbf{+55 bps}                            & 5.28\%                               & \textbf{+56 bps}                     & 5.41\%                              & \textbf{+58 bps}                    \\ \arrayrulecolor{light_grey}\hline
...
\adjustbox{valign=t}{\begin{minipage}[t]{15cm}
		...
		US Govt/AAA Repo & 49.9\% & 115.9\% \\
		IG Repo: AA to A & 29.1\% & 118.7\% \\
		IG Repo: BBB & 18.5\% & 127.0\% \\
		Repo: BB & - & - \\
		T-Bills; Gov't MMF & 2.5\% & - \\ \cline{2-2} \cline{3-3} 
		\textbf{Total} & 100.0\% & \textbf{118.8\%} \\\arrayrulecolor{light_grey}\hline
		\end{tabular}
...
\textbf{Related Fund Series Size} & \textbf{\$856.3 million} & Issuing \& Paying Agent & Bank of NY Mellon \\ 
...
{\color[HTML]{FFFFFF} \textbf{Current Principal}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{\$410.2 million}} \\
...
09/14/23 &\textbf{10/19/23} &\textbf{5.83\%} &1m SOFR+51 &\$205,250,000 &\$1,163,368.40 &10/19/23 &\$205,250,000 &117.2\% \\
...
05/16/24 &\textbf{06/13/24} &\textbf{5.82\%} &1m SOFR+50 &\$325,250,000 &\$1,472,298.33 &06/13/24 &\$325,250,000 &122.3\% \\
06/13/24 &\textbf{07/18/24} &\textbf{5.81\%} &1m SOFR+48 &\$425,250,000 &\$1,837,210.76 &07/18/24 &\$425,250,000 &120.6\% \\
07/18/24 &\textbf{08/15/24} &\textbf{5.81\%} &1m SOFR+48 &\$410,250,000 &\$1,853,874.17 &08/15/24 &\$410,250,000 &118.8\% \\
08/15/24 &\textbf{09/12/24} &\textbf{5.82\%{\tiny (Est'd)}} &1m SOFR+48 &\$410,250,000 &n/a &09/12/24 &\$410,250,000 &n/a \\
