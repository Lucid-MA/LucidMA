...
\textbf{Lucid Prime Series QX-1 / Note Series QX-1}
} \\
{\color[HTML]{FFFFFF} \textbf{Issuer}} & \multicolumn{2}{p{11.78cm}!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF} 
Prime Notes LLC
} \\
{\color[HTML]{FFFFFF} \textbf{Redemption \& Coupon Frequency}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{Quarterly}} \\
{\color[HTML]{FFFFFF} \textbf{Rating}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{A} by Egan-Jones} \\
{\color[HTML]{FFFFFF} \textbf{Current Target Return of Notes}\textsuperscript{1}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{3m SOFR + 94-98 bps}}\\
{\color[HTML]{FFFFFF} \textbf{Previous Coupon Period}} & April 18 - July 18 & \textbf{6.27\%} (3m SOFR + 94 bps) \\
{\color[HTML]{FFFFFF} \textbf{Current Period Est'd Coupon}\textsuperscript{2}} & July 18 - October 17 & \textbf{6.17\%}  (3m SOFR + 89 bps) \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
\end{center}
...
\arrayrulecolor{light_grey}\hline
\rowcolor{lucid_blue} 
{\color[HTML]{FFFFFF} \textbf{ Series / Comparables}}               & \multicolumn{2}{m{\quarterwidth}!{\color{light_grey}\vrule}}{\cellcolor{lucid_blue}\centering {\color[HTML]{FFFFFF} \textbf{Previous Period}}} & \multicolumn{2}{m{\quarterwidtha}!{\color{light_grey}\vrule}}{\cellcolor{lucid_blue}\centering {\color[HTML]{FFFFFF} \textbf{6 Months}}} & \multicolumn{2}{m{\quarterwidtha}!{\color{light_grey}\vrule}}{\cellcolor{lucid_blue}\centering {\color[HTML]{FFFFFF} \textbf{1 Year}}} \\ 
\rowcolor{lucid_blue}  
{\color[HTML]{FFFFFF}} & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}                & {\color[HTML]{FFFFFF} Spread}               & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}        & {\color[HTML]{FFFFFF} Spread}        & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}       & {\color[HTML]{FFFFFF} Spread}       \\ \arrayrulecolor{light_grey}\hline
	...
	\textbf{Lucid Prime - Series QX-1}                    & \textbf{6.27\%}                              & \textbf{-}                                  & \textbf{6.31\%}                               & \textbf{-}                           & \textbf{6.44\%}                             & \textbf{-}                          \\
3m SOFR                       & 5.33\%                                       & \textbf{+94 bps}                            & 5.35\%                               & \textbf{+96 bps}                     & 5.45\%                              & \textbf{+99 bps}                    \\
3m A1/P1 CP                       & 5.38\%                                       & \textbf{+89 bps}                           & 5.39\%                               & \textbf{+92 bps}                     & 5.50\%                              & \textbf{+94 bps}                    \\
3m T-Bill                       & 5.20\%                                       & \textbf{+107 bps}                            & 5.26\%                               & \textbf{+105 bps}                     & 5.40\%                              & \textbf{+104 bps}                    \\ \arrayrulecolor{light_grey}\hline
...
\end{tabular}
	...
	\begin{axis}[
		...
		ymin=3, ymax=7.27, %MAXRETURN HERE
	   symbolic x coords={Series QX-1,3m SOFR,3m A1/P1 CP,3m T-Bill},
		xtick={Series QX-1,3m SOFR,3m A1/P1 CP,3m T-Bill},
...
\adjustbox{valign=t}{\begin{minipage}[t]{15cm}
		...
		\multicolumn{3}{!{\color{light_grey}\vrule}p{8.2cm}!{\color{light_grey}\vrule}}{\rowcolor[HTML]{EFEFEF}{\textbf{Series QX}: Secured by \textbf{Investment Grade and BB rated Collateral securities (subject to a 50\% limit on BB collateral)}, with daily valuations \& margining.}} \\
		& & \\
		 & \textbf{\% Portfolio} & \textbf{O/C Rate}\\
		US Govt/AAA Repo & 7.8\% & 127.0\% \\
		IG Repo: AA to A & 7.5\% & 122.0\% \\
		IG Repo: BBB & 39.6\% & 131.3\% \\
		Repo: BB & - & - \\
		T-Bills; Gov't MMF & 8.0\% & - \\ \cline{2-2} \cline{3-3} 
		\textbf{Total} & 100.0\% & \textbf{135.5\%} \\\arrayrulecolor{light_grey}\hline
		\end{tabular}
...
\textbf{Related Fund Series Size} & \textbf{\$244.4 million} & Issuing \& Paying Agent & Bank of NY Mellon \\ 
...
\textbf{QX-1} (Secured by related fund series QX-1)
} \\
{\color[HTML]{FFFFFF} \textbf{Current Principal}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{\$38.5 million}} \\
{\color[HTML]{FFFFFF} \textbf{Original Issue Date}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}July 20, 2018} \\
{\color[HTML]{FFFFFF} \textbf{Final Maturity Date}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}April 09, 2026} \\
{\color[HTML]{FFFFFF} \textbf{Next Coupon Payment Date}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}October 17, 2024} \\
{\color[HTML]{FFFFFF} \textbf{Next Redemption Date (Put Date)}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{October 17, 2024}} \\
{\color[HTML]{FFFFFF} \textbf{Next Notice Date for Redemption}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}September 04, 2024} \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
\end{center}
...
10/19/23 &\textbf{01/18/24} &\textbf{6.35\%} &3m SOFR+95 &\$38,500,000 &\$778,492.36 &01/18/24 &\$38,500,000 &132.9\% \\
01/18/24 &\textbf{04/18/24} &\textbf{6.25\%} &3m SOFR+95 &\$38,500,000 &\$608,246.53 &04/18/24 &\$38,500,000 &131.4\% \\
04/18/24 &\textbf{07/18/24} &\textbf{6.27\%} &3m SOFR+94 &\$38,500,000 &\$610,192.92 &07/18/24 &\$38,500,000 &135.5\% \\
07/18/24 &\textbf{10/17/24} &\textbf{6.17\%{\tiny (Est'd)}} &3m SOFR+89 &\$38,500,000 &n/a &10/17/24 &\$38,500,000 &1000000.0\% \\
