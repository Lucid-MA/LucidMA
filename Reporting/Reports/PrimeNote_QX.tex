...
\textbf{Lucid Prime Series QX / Note Series QX-1}
} \\
...
{\color[HTML]{FFFFFF} \textbf{Rating}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{A} by Egan-Jones (NAIC 1)} \\
...
\textbf{QX-1} (Secured by related fund series QX)
} \\
...
07/18/24 &\textbf{10/17/24} &\textbf{6.17\%{\tiny (Est'd)}} &3m SOFR+89 &\$38,500,000 &n/a &10/17/24 &\$38,500,000 &n/a \\
