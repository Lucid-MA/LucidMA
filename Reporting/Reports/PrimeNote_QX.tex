...
\adjustbox{valign=t}{\begin{minipage}[t]{15cm}
		...
		US Govt/AAA Repo & 14.0\% & 112.6\% \\
		IG Repo: AA to A & 18.2\% & 120.2\% \\
		IG Repo: BBB & 26.7\% & 133.1\% \\
		Repo: BB & - & - \\
		T-Bills; Gov't MMF & 8.7\% & - \\ \cline{2-2} \cline{3-3} 
		\textbf{Total} & 100.0\% & \textbf{130.5\%} \\\arrayrulecolor{light_grey}\hline
		\end{tabular}
...
\textbf{Related Fund Series Size} & \textbf{\$211.3 million} & Issuing \& Paying Agent & Bank of NY Mellon \\ 
\textbf{Lucid Prime Program Size} & \textbf{\$3.18 billion} & Collateral Agent & Bank of NY Mellon \\ 
