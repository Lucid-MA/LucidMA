...
{\color[HTML]{FFFFFF} \textbf{Previous Coupon Period}} & January 18 - April 18 & \textbf{6.25\%} (3m SOFR + 95 bps) \\
{\color[HTML]{FFFFFF} \textbf{Current Period Est'd Coupon}\textsuperscript{2}} & April 18 - July 18 & \textbf{6.27\%}  (3m SOFR + 94 bps) \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
\end{center}
...
{\color[HTML]{FFFFFF}} & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}                & {\color[HTML]{FFFFFF} Spread}               & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}        & {\color[HTML]{FFFFFF} Spread}        & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}       & {\color[HTML]{FFFFFF} Spread}       \\ \arrayrulecolor{light_grey}\hline
	...
	\textbf{Lucid Prime - Series QX-1}                    & \textbf{6.25\%}                              & \textbf{-}                                  & \textbf{6.36\%}                               & \textbf{-}                           & \textbf{6.36\%}                             & \textbf{-}                          \\
...
\adjustbox{valign=t}{\begin{minipage}[t]{15cm}
		...
		US Govt/AAA Repo & 8.0\% & 111.0\% \\
		IG Repo: AA to A & 7.4\% & 123.5\% \\
		IG Repo: BBB & 41.5\% & 132.9\% \\
		Repo: BB & - & - \\
		T-Bills; Gov't MMF & 7.2\% & - \\ \cline{2-2} \cline{3-3} 
		\textbf{Total} & 100.0\% & \textbf{134.8\%} \\\arrayrulecolor{light_grey}\hline
		\end{tabular}
...
\textbf{Related Fund Series Size} & \textbf{\$714.0 million} & Issuing \& Paying Agent & Bank of NY Mellon \\ 
...
{\color[HTML]{FFFFFF} \textbf{Next Notice Date for Redemption}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}June 04, 2024} \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
\end{center}
...
10/19/23 &\textbf{01/18/24} &\textbf{6.35\%} &3m SOFR+95 &\$38,500,000 &\$617,978.47 &01/18/24 &\$38,500,000 &132.04\% \\
01/18/24 &\textbf{04/18/24} &\textbf{6.25\%} &3m SOFR+95 &\$38,500,000 &\$608,246.53 &04/18/24 &\$38,500,000 &130.52\% \\
04/18/24 &\textbf{07/18/24} &\textbf{6.27\%{\tiny (Est'd)}} &3m SOFR+94 &\$38,500,000 &n/a &07/18/24 &\$38,500,000 &n/a \\
