...
{\color[HTML]{FFFFFF} \textbf{Program Series}} & \multicolumn{2}{p{\halfwidthb}!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{Lucid Prime - Series QX}} \\[1.5mm]
...
The fund series seeks income generation with 100\% capital preservation and primarily invests in repurchase agreements limited to Investment Grade and BB rated Collateral Securities (subject to a 50\% limit on BB collateral), Single-A Bank Guaranteed Collateral or other high quality money market securities. Series QX interests have (i) maximum maturities of 3 months on all series assets, (ii) monthly withdrawal dates.} \\[5.5em]
{\color[HTML]{FFFFFF} \textbf{Current Target Return}\textsuperscript{1}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{3m SOFR + 94-98 bps}} \\
{\color[HTML]{FFFFFF} \textbf{Previous Period Return}} & January 18 - April 18 & \textbf{6.25\%} (3m SOFR + 95 bps) \\ 
{\color[HTML]{FFFFFF} \textbf{Current Period Est'd Return}\textsuperscript{2}} & April 18 - July 18 & \textbf{6.27\%}  (3m SOFR + 94 bps) \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
...
\arrayrulecolor{light_grey}\hline
\rowcolor{lucid_blue} 
{\color[HTML]{FFFFFF} \textbf{Net Returns}\textsuperscript{3}}               & \multicolumn{2}{m{\quarterwidth}!{\color{light_grey}\vrule}}{\cellcolor{lucid_blue}\centering {\color[HTML]{FFFFFF} \textbf{Previous Period}}} & \multicolumn{2}{m{\quarterwidtha}!{\color{light_grey}\vrule}}{\cellcolor{lucid_blue}\centering {\color[HTML]{FFFFFF} \textbf{6 Months}}} & \multicolumn{2}{m{\quarterwidtha}!{\color{light_grey}\vrule}}{\cellcolor{lucid_blue}\centering {\color[HTML]{FFFFFF} \textbf{1 Year}}} \\
\rowcolor{lucid_blue}  
{\color[HTML]{FFFFFF} Series / Comparables} & {\color[HTML]{FFFFFF} Return}                & {\color[HTML]{FFFFFF} Spread}               & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}        & {\color[HTML]{FFFFFF} Spread}        & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}       & {\color[HTML]{FFFFFF} Spread}       \\ \arrayrulecolor{light_grey}\hline
	...
	\textbf{Lucid Prime - Series QX}                    & \textbf{6.25\%}                              & \textbf{-}                                  & \textbf{6.36\%}                               & \textbf{-}                           & \textbf{6.36\%}                             & \textbf{-}                          \\
3m SOFR                       & 5.30\%                                       & \textbf{+95 bps}                            & 5.39\%                               & \textbf{+97 bps}                     & 5.35\%                              & \textbf{+101 bps}                    \\
3m A1/P1 CP                       & 5.33\%                                       & \textbf{+92 bps}                           & 5.45\%                               & \textbf{+91 bps}                     & 5.36\%                              & \textbf{+100 bps}                    \\
3m T-Bill                       & 5.25\%                                       & \textbf{+100 bps}                            & 5.36\%                               & \textbf{+100 bps}                     & 5.31\%                              & \textbf{+105 bps}                    \\ \arrayrulecolor{light_grey}\hline
...
Fund Size & \$3.18 billion\\
Series Size & \$211.3 million\\
Lucid AUM & \$4.8 billion\\
Series Rating & A by Egan-Jones\\
Series Withdrawal & Monthly at par\\
Next Withdrawal & July 18, 2024\\
Next Notice Date & June 04, 2024\\
...
Series Inception & March 22, 2021\\ \arrayrulecolor{light_grey}\hline
\end{tabular}
...
US Govt/AAA Repo & 14.04\% & 112.58\% \\
IG Repo: AA to A & 18.2\% & 120.2\% \\
		IG Repo: BBB & 26.7\% & 133.1\% \\
		Repo: BB & - & - \\
T-Bills; Gov't MMF & 8.74\% & - \\ \cline{2-2} \cline{3-3} 
\textbf{Total} & 100.0\% & \textbf{130.52\%} \\\arrayrulecolor{light_grey}\hline
\end{tabular}
...
%     bottom color=transparent!0]
	...
	\begin{axis}[
		...
		date coordinates in=x, date ZERO=2025-07-17,
		xticklabel=\month/\day/\year,  
		ymin=0, ymax=8, %MAXRETURN HERE
		legend cell align = {left},
		legend style={at={(0.2,1)},
		  anchor=north east, font=\tiny, draw=none,fill=none},
		  x=0.075mm, %CHANGE THIS to tighten in graph, eg if quarterly
	...
	\addplot[ybar, nodes near coords, fill=lucid_blue, rounded corners=1pt,blur shadow={shadow yshift=-1pt, shadow xshift=1pt}] 
		coordinates {
			(2021-10-14, 0.90) (2022-01-13, 0.83) (2022-04-14, 0.92) (2022-07-14, 1.72) (2022-10-13, 3.20) (2023-01-12, 4.70) (2023-04-13, 5.58) (2023-07-20, 5.95) (2023-10-19, 6.30) (2024-01-18, 6.35) (2024-04-18, 6.25)
		};
	\addplot[draw=dark_red,ultra thick,smooth] 
		coordinates {
			(2021-04-15, 0.07) (2021-07-15, 0.03) (2021-10-14, 0.05) (2022-01-13, 0.05) (2022-04-14, 0.13) (2022-07-14, 0.81) (2022-10-13, 2.30) (2023-01-12, 3.78) (2023-04-13, 4.63) (2023-07-20, 4.98) (2023-10-19, 5.33) (2024-01-18, 5.40) (2024-04-18, 5.30)
		};
	\addplot[draw=dark_color,ultra thick,smooth] 
		coordinates {
			(2021-04-15, 0.12) (2021-07-15, 0.08) (2021-10-14, 0.07) (2022-01-13, 0.07) (2022-04-14, 0.13) (2022-07-14, 0.87) (2022-10-13, 2.18) (2023-01-12, 3.70) (2023-04-13, 4.59) (2023-07-20, 4.86) (2023-10-19, 5.37) (2024-01-18, 5.49) (2024-04-18, 5.33)
		};
	\legend{\hphantom{A}Prime Series QX,\hphantom{A}3m SOFR,\hphantom{A}3m A1/P1 CP}
	\end{axis}
		\end{tikzpicture}}
