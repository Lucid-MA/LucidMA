...
US Govt/AAA Repo & 9.0\% & 135.7\% \\
IG Repo: AA to A & 5.2\% & 121.1\% \\
		IG Repo: BBB & 45.2\% & 131.9\% \\
		Repo: BB & - & - \\
T-Bills; Gov't MMF & 3.2\% & - \\ \cline{2-2} \cline{3-3} 
\textbf{Total} & 100.0\% & \textbf{136.9\%} \\\arrayrulecolor{light_grey}\hline
\end{tabular}
