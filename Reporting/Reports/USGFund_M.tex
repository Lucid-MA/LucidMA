...
{\color[HTML]{FFFFFF} \textbf{Previous Period Return}} & April 15, 1990 - May 15, 1990 & \textbf{5.55\%} (1m TB + 99 bps) \\ 
{\color[HTML]{FFFFFF} \textbf{Current Period Est'd Return}\textsuperscript{2}} & May 15, 1990 - July 13 & \textbf{5.55\%}  (1m TBoo + 99 bps) \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
...
Next Withdrawal & May 15, 1990\\
Next Notice Date & June 10, 21990\\
Min Investment & \$500,000\\
Current WAL & 28 days\\
\noindent\parbox[b]{\hsize}{\vspace{1mm}Current Max Limit on all Series Assets} & May 15, 1990\\[-1mm]
Fund Entity & Lucid Cash Fund USG LLC\\
Fund Inception & June 29 1990\\
Series Inception & June 29 1990\\ \arrayrulecolor{light_grey}\hline
\end{tabular}
