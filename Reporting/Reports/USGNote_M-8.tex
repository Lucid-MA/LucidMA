...
\textbf{Lucid Test Fund Name Series M / Note Series M-8}
} \\
...
{\color[HTML]{FFFFFF} \textbf{Rating}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{AAA} by Edgar Jones LLC} \\
...
{\color[HTML]{FFFFFF} \textbf{Previous Coupon Period}} & April 15, 1990 - May 15, 1990 & \textbf{5.55\%} (1m TB + 99 bps) \\
{\color[HTML]{FFFFFF} \textbf{Current Period Est'd Coupon}\textsuperscript{2}} & May 15, 1990 - July 13 & \textbf{5.55\%}  (1m TBoo + 99 bps) \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
\end{center}
...
\arrayrulecolor{light_grey}\hline
\rowcolor{lucid_blue} 
{\color[HTML]{FFFFFF} \textbf{ Series / Comparables}}               & \multicolumn{2}{m{\quarterwidth}!{\color{light_grey}\vrule}}{\cellcolor{lucid_blue}\centering {\color[HTML]{FFFFFF} \textbf{Previous Period}}} & \multicolumn{2}{m{\quarterwidtha}!{\color{light_grey}\vrule}}{\cellcolor{lucid_blue}\centering {\color[HTML]{FFFFFF} \textbf{12 Months}}} & \multicolumn{2}{m{\quarterwidtha}!{\color{light_grey}\vrule}}{\cellcolor{lucid_blue}\centering {\color[HTML]{FFFFFF} \textbf{12 Years}}} \\ 
\rowcolor{lucid_blue}  
...
\textbf{Lucid Test Fund Name Program Size} & \textbf{\$123.0 million} & Collateral Agent & Bank of NY Mellon \\ 
\textbf{Lucid Platform AUM} & \textbf{\$4.65 billion} & Auditor & KPMG \\ 
Test Fund Name Program Inception & June 29 1990 & & \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
\end{center}
