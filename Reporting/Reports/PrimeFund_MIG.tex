...
{\color[HTML]{FFFFFF} Series / Comparables} & {\color[HTML]{FFFFFF} Return}                & {\color[HTML]{FFFFFF} Spread}               & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}        & {\color[HTML]{FFFFFF} Spread}        & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}       & {\color[HTML]{FFFFFF} Spread}       \\ \arrayrulecolor{light_grey}\hline
	...
	\textbf{Lucid Prime - Series MIG}                    & \textbf{5.92\%}                              & \textbf{-}                                  & \textbf{5.95\%}                               & \textbf{-}                           & \textbf{6.09\%}                             & \textbf{-}                          \\
1m SOFR                       & 5.32\%                                       & \textbf{+60 bps}                            & 5.35\%                               & \textbf{+60 bps}                     & 5.44\%                              & \textbf{+65 bps}                    \\
1m A1/P1 CP                       & 5.32\%                                       & \textbf{+60 bps}                           & 5.34\%                               & \textbf{+61 bps}                     & 5.43\%                              & \textbf{+66 bps}                    \\
1m T-Bill                       & 5.27\%                                       & \textbf{+65 bps}                            & 5.31\%                               & \textbf{+64 bps}                     & 5.38\%                              & \textbf{+71 bps}                    \\ \arrayrulecolor{light_grey}\hline
