...
1m SOFR                       & 5.33\%                                       & \textbf{+58 bps}                            & 5.35\%                               & \textbf{+60 bps}                     & 5.46\%                              & \textbf{+62 bps}                    \\
1m A1/P1 CP                       & 5.31\%                                       & \textbf{+60 bps}                           & 5.34\%                               & \textbf{+61 bps}                     & 5.44\%                              & \textbf{+64 bps}                    \\
1m T-Bill                       & 5.26\%                                       & \textbf{+65 bps}                            & 5.30\%                               & \textbf{+65 bps}                     & 5.41\%                              & \textbf{+67 bps}                    \\ \arrayrulecolor{light_grey}\hline
