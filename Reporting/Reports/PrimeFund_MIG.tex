...
{\color[HTML]{FFFFFF} \textbf{Previous Period Return}} & May 16 - June 13 & \textbf{5.92\%} (1m SOFR + 60 bps) \\ 
{\color[HTML]{FFFFFF} \textbf{Current Period Est'd Return}\textsuperscript{2}} & June 13 - July 18 & \textbf{5.92\%}  (1m SOFR + 59 bps) \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
...
{\color[HTML]{FFFFFF} Series / Comparables} & {\color[HTML]{FFFFFF} Return}                & {\color[HTML]{FFFFFF} Spread}               & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}        & {\color[HTML]{FFFFFF} Spread}        & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}       & {\color[HTML]{FFFFFF} Spread}       \\ \arrayrulecolor{light_grey}\hline
	...
	\textbf{Lucid Prime - Series MIG}                    & \textbf{5.92\%}                              & \textbf{-}                                  & \textbf{5.96\%}                               & \textbf{-}                           & \textbf{6.08\%}                             & \textbf{-}                          \\
...
US Govt/AAA Repo & 25.13\% & 116.84\% \\
IG Repo: AA to A & 22.5\% & 119.9\% \\
		IG Repo: BBB & 42.4\% & 127.9\% \\
		Repo: BB & - & - \\
T-Bills; Gov't MMF & 9.96\% & - \\ \cline{2-2} \cline{3-3} 
\textbf{Total} & 100.0\% & \textbf{122.84\%} \\\arrayrulecolor{light_grey}\hline
\end{tabular}
...
%     bottom color=transparent!0]
	...
	\addplot[ybar, nodes near coords, fill=lucid_blue, rounded corners=1pt,blur shadow={shadow yshift=-1pt, shadow xshift=1pt}] 
		coordinates {
			(2023-03-09, 5.16) (2023-04-13, 5.33) (2023-05-11, 5.51) (2023-06-15, 5.68) (2023-07-20, 5.78) (2023-08-17, 5.87) (2023-09-14, 5.93) (2023-10-19, 5.93) (2023-11-16, 5.93) (2023-12-14, 5.93) (2024-01-18, 5.96) (2024-02-15, 5.93) (2024-03-14, 5.92) (2024-04-18, 5.93) (2024-05-16, 5.92) (2024-06-13, 5.92)
		};
