...
Series MIG interests have (i) maximum maturities of 1 month on all series assets, (ii) monthly withdrawal dates and (iii) all Eligible Collateral for repurchase agreements must be Investment Grade securities only or USG securities.} \\[5.5em]
{\color[HTML]{FFFFFF} \textbf{Current Target Return}\textsuperscript{1}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{1m SOFR + 60-62 bps}} \\
{\color[HTML]{FFFFFF} \textbf{Previous Period Return}} & February 15, 2024 - March 14, 2024 & \textbf{5.92\%} (1m SOFR + 60 bps) \\ 
{\color[HTML]{FFFFFF} \textbf{Current Period Est'd Return}\textsuperscript{2}} & March 14, 2024 - April 18, 2024 & \textbf{5.93\%}  (1m SOFR + 60 bps) \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
...
{\color[HTML]{FFFFFF} Series / Comparables} & {\color[HTML]{FFFFFF} Return}                & {\color[HTML]{FFFFFF} Spread}               & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}        & {\color[HTML]{FFFFFF} Spread}        & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}       & {\color[HTML]{FFFFFF} Spread}       \\ \arrayrulecolor{light_grey}\hline
	...
	\textbf{Lucid Prime - Series MIG}                    & \textbf{5.92\%}                              & \textbf{-}                                  & \textbf{5.97\%}                               & \textbf{-}                           & \textbf{5.96\%}                             & \textbf{-}                          \\
1m SOFR                       & 5.33\%                                       & \textbf{+59 bps}                            & 5.36\%                               & \textbf{+61 bps}                     & 5.32\%                              & \textbf{+64 bps}                    \\
1m A1/P1 CP                       & 5.30\%                                       & \textbf{+62 bps}                           & 5.36\%                               & \textbf{+61 bps}                     & 5.28\%                              & \textbf{+68 bps}                    \\
1m T-Bill                       & 5.29\%                                       & \textbf{+63 bps}                            & 5.30\%                               & \textbf{+67 bps}                     & 5.18\%                              & \textbf{+78 bps}                    \\ \arrayrulecolor{light_grey}\hline
...
US Govt/AAA Repo & 15.55\% & 115.20\% \\
IG Repo: AA to A & 33.8\% & 124.0\% \\
		IG Repo: BBB & 47.6\% & 127.3\% \\
		Repo: BB & - & - \\
T-Bills; Gov't MMF & 3.12\% & - \\ \cline{2-2} \cline{3-3} 
\textbf{Total} & 100.0\% & \textbf{124.20\%} \\\arrayrulecolor{light_grey}\hline
\end{tabular}
...
%     bottom color=transparent!0]
	...
	\addplot[ybar, nodes near coords, fill=lucid_blue, rounded corners=1pt,blur shadow={shadow yshift=-1pt, shadow xshift=1pt}] 
		coordinates {
			(2023-01-12, 4.86) (2023-02-09, 5.05) (2023-03-09, 5.16) (2023-04-13, 5.33) (2023-05-11, 5.51) (2023-06-15, 5.68) (2023-07-20, 5.78) (2023-08-17, 5.87) (2023-09-14, 5.93) (2023-10-19, 5.93) (2023-11-16, 5.93) (2023-12-14, 5.93) (2024-01-18, 5.96) (2024-02-15, 5.93) (2024-03-14, 5.92) (2024-04-18, 5.93)
		};
