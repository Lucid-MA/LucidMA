...
{\color[HTML]{FFFFFF} \textbf{Previous Period Return}} & May 16, 2024 - June 13, 2024 & \textbf{5.92\%} (1m SOFR + 60 bps) \\ 
{\color[HTML]{FFFFFF} \textbf{Current Period Est'd Return}\textsuperscript{2}} & June 13, 2024 - July 18, 2024 & \textbf{5.92\%}  (1m SOFR + 59 bps) \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
...
IG Repo: AA to A & 27.6\% & 122.3\% \\
		...
		Repo: BB & - & - \\
T-Bills; Gov't MMF & 2.96\% & - \\ \cline{2-2} \cline{3-3} 
\textbf{Total} & 100.0\% & \textbf{122.50\%} \\\arrayrulecolor{light_grey}\hline
\end{tabular}
