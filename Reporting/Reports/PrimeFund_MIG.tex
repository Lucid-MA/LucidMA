...
{\color[HTML]{FFFFFF} \textbf{Previous Period Return}} & July 18 - August 15 & \textbf{5.91\%} (1m SOFR + 58 bps) \\ 
{\color[HTML]{FFFFFF} \textbf{Current Period Est'd Return}\textsuperscript{2}} & August 15 - September 12 & \textbf{5.92\%}  (1m SOFR + 58 bps) \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
