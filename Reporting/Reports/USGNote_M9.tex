...
\textbf{Lucid USG Series M-9 / Note Series M-9}
} \\
...
{\color[HTML]{FFFFFF}} & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}                & {\color[HTML]{FFFFFF} Spread}               & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}        & {\color[HTML]{FFFFFF} Spread}        & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}       & {\color[HTML]{FFFFFF} Spread}       \\ \arrayrulecolor{light_grey}\hline
	...
	\textbf{Lucid USG - Series M-9}                    & \textbf{5.52\%}                              & \textbf{-}                                  & \textbf{5.55\%}                               & \textbf{-}                           & \textbf{5.63\%}                             & \textbf{-}                          \\
...
\end{tabular}
	...
	\begin{axis}[
	   ...
	   symbolic x coords={Series M-9,1m T-Bill,Crane Govt},
		xtick={Series M-9,1m T-Bill,Crane Govt},
...
\adjustbox{valign=t}{\begin{minipage}[t]{15cm}
		...
		US Govt Repo & 92.9\% & 106.6\% \\
		T-Bills; Gov't MMF & 7.1\% & - \\ \cline{2-2} \cline{3-3} 
		\textbf{Total} & 100.0\% & \textbf{106.6\%} \\\arrayrulecolor{light_grey}\hline
		\end{tabular}
...
\textbf{Related Fund Series Size} & \textbf{\$123.8 million} & Issuing \& Paying Agent & Bank of NY Mellon \\ 
...
\textbf{M-9} (Secured by related fund series M-9)
} \\
{\color[HTML]{FFFFFF} \textbf{Current Principal}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{\$50.0 million}} \\
{\color[HTML]{FFFFFF} \textbf{Original Issue Date}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}February 15, 2024} \\
{\color[HTML]{FFFFFF} \textbf{Final Maturity Date}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}February 05, 2025} \\
...
12/14/23 &\textbf{01/18/24} &\textbf{5.53\%} &1m TB+20 &\$50,000,000 &\$265,136.99 &01/18/24 &\$50,000,000 &107.81\% \\
01/18/24 &\textbf{02/15/24} &\textbf{5.53\%} &1m TB+17 &\$50,000,000 &\$212,109.59 &02/15/24 &\$50,000,000 &105.42\% \\
02/15/24 &\textbf{03/14/24} &\textbf{5.53\%} &1m TB+17 &\$50,000,000 &\$212,109.59 &03/14/24 &\$50,000,000 &106.66\% \\
03/14/24 &\textbf{04/18/24} &\textbf{5.53\%} &1m TB+16 &\$50,000,000 &\$265,136.99 &04/18/24 &\$50,000,000 &101.18\% \\
04/18/24 &\textbf{05/16/24} &\textbf{5.53\%} &1m TB+16 &\$50,000,000 &\$212,109.59 &05/16/24 &\$50,000,000 &107.01\% \\
05/16/24 &\textbf{06/13/24} &\textbf{5.52\%} &1m TB+18 &\$50,000,000 &\$211,726.03 &06/13/24 &\$50,000,000 &106.77\% \\
06/13/24 &\textbf{07/18/24} &\textbf{5.52\%{\tiny (Est'd)}} &1m TB+19 &\$50,000,000 &n/a &07/18/24 &\$50,000,000 &n/a \\
