...
\adjustbox{valign=t}{\begin{minipage}[t]{15cm}
		...
		US Govt Repo & 95.5\% & 107.4\% \\
		T-Bills; Gov't MMF & 4.5\% & - \\ \cline{2-2} \cline{3-3} 
		\textbf{Total} & 100.0\% & \textbf{107.4\%} \\\arrayrulecolor{light_grey}\hline
		\end{tabular}
...
\textbf{Related Fund Series Size} & \textbf{\$123.3 million} & Issuing \& Paying Agent & Bank of NY Mellon \\ 
