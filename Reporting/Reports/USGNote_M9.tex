...
{\color[HTML]{FFFFFF} \textbf{Previous Coupon Period}} & May 16, 2024 - June 13, 2024 & \textbf{5.45\%} (1m TB + 18 bps) \\
{\color[HTML]{FFFFFF} \textbf{Current Period Est'd Coupon}\textsuperscript{2}} & June 13, 2024 - July 18, 2024 & \textbf{5.52\%}  (1m TB + 19 bps) \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
\end{center}
...
{\color[HTML]{FFFFFF}} & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}                & {\color[HTML]{FFFFFF} Spread}               & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}        & {\color[HTML]{FFFFFF} Spread}        & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}       & {\color[HTML]{FFFFFF} Spread}       \\ \arrayrulecolor{light_grey}\hline
	...
	\textbf{Lucid USG - Series M-9}                    & \textbf{5.45\%}                              & \textbf{-}                                  & \textbf{5.55\%}                               & \textbf{-}                           & \textbf{5.63\%}                             & \textbf{-}                          \\
...
\end{tabular}
	...
	\begin{axis}[
		...
		ymin=2, ymax=6.34, %MAXRETURN HERE
...
USG Program Inception & February 15, 2024 & & \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
\end{center}
...
{\color[HTML]{FFFFFF} \textbf{Original Issue Date}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}June 29, 2017} \\
{\color[HTML]{FFFFFF} \textbf{Final Maturity Date}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}10   2025-02-05
Name: final_maturity_date, dtype: datetime64[ns]} \\
{\color[HTML]{FFFFFF} \textbf{Next Coupon Payment Date}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}July 15, 2024} \\
{\color[HTML]{FFFFFF} \textbf{Next Redemption Date (Put Date)}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{July 15, 2024}} \\
