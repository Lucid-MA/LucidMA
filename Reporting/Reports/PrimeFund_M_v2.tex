...
\textbf{{Series M}} interests have (i) maximum maturities of 1 month on all series assets, (ii) monthly withdrawal dates and (iii) all Eligible Collateral for repurchase agreements must be Highly Rated Investment Grade securities (at least 75\% rated  between AAA and A- or USG securities).} \\[5.5em]
...
Series Inception & August 15, 2018\\ \arrayrulecolor{light_grey}\hline
\end{tabular}
