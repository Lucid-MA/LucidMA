...
\textbf{{Series Q1}} interests have (i) maximum maturities of 3 months on all series assets, (ii) quarterly withdrawal dates and (iii) all Eligible Collateral for repurchase agreements must be Investment Grade securities only or USG securities.} \\[5.5em]
