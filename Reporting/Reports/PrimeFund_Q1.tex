...
{\color[HTML]{FFFFFF} \textbf{Current Target Return}\textsuperscript{1}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{3m SOFR + 66-68 bps}} \\
{\color[HTML]{FFFFFF} \textbf{Previous Period Return}} & April 18 - July 18 & \textbf{6.03\%} (3m SOFR + 70 bps) \\ 
{\color[HTML]{FFFFFF} \textbf{Current Period Est'd Return}\textsuperscript{2}} & July 18 - October 17 & \textbf{5.95\%}  (3m SOFR + 67 bps) \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
...
{\color[HTML]{FFFFFF} Series / Comparables} & {\color[HTML]{FFFFFF} Return}                & {\color[HTML]{FFFFFF} Spread}               & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}        & {\color[HTML]{FFFFFF} Spread}        & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}       & {\color[HTML]{FFFFFF} Spread}       \\ \arrayrulecolor{light_grey}\hline
	...
	\textbf{Lucid Prime - Series Q1}                    & \textbf{6.03\%}                              & \textbf{-}                                  & \textbf{6.06\%}                               & \textbf{-}                           & \textbf{6.18\%}                             & \textbf{-}                          \\
...
%     bottom color=transparent!0]
	...
	\begin{axis}[
		...
		date coordinates in=x, date ZERO=2020-10-15,
	...
	\addplot[ybar, nodes near coords, fill=lucid_blue, rounded corners=1pt,blur shadow={shadow yshift=-1pt, shadow xshift=1pt}] 
		coordinates {
			(2021-07-15, 0.89) (2021-10-14, 0.65) (2022-01-13, 0.58) (2022-04-14, 0.69) (2022-07-14, 1.46) (2022-10-13, 2.92) (2023-01-12, 4.42) (2023-04-13, 5.33) (2023-07-20, 5.71) (2023-10-19, 6.05) (2024-01-18, 6.10) (2024-04-18, 6.00) (2024-07-18, -395.60)
		};
