...
{\color[HTML]{FFFFFF} Series / Comparables} & {\color[HTML]{FFFFFF} Return}                & {\color[HTML]{FFFFFF} Spread}               & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}        & {\color[HTML]{FFFFFF} Spread}        & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}       & {\color[HTML]{FFFFFF} Spread}       \\ \arrayrulecolor{light_grey}\hline
	...
	\textbf{Lucid Prime - Series Q1}                    & \textbf{6.03\%}                              & \textbf{-}                                  & \textbf{6.02\%}                               & \textbf{-}                           & \textbf{6.16\%}                             & \textbf{-}                          \\
3m SOFR                       & 5.33\%                                       & \textbf{+70 bps}                            & 5.35\%                               & \textbf{+67 bps}                     & 5.45\%                              & \textbf{+71 bps}                    \\
3m A1/P1 CP                       & 5.38\%                                       & \textbf{+65 bps}                           & 5.39\%                               & \textbf{+63 bps}                     & 5.50\%                              & \textbf{+66 bps}                    \\
3m T-Bill                       & 5.20\%                                       & \textbf{+83 bps}                            & 5.26\%                               & \textbf{+76 bps}                     & 5.40\%                              & \textbf{+76 bps}                    \\ \arrayrulecolor{light_grey}\hline
