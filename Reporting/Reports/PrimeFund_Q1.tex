...
{\color[HTML]{FFFFFF} \textbf{Program Series}} & \multicolumn{2}{p{\halfwidthb}!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{Lucid Prime - Series Q1}} \\[1.5mm]
...
Series Q1 interests have (i) maximum maturities of 3 months on all series assets, (ii) quarterly withdrawal dates and (iii) all Eligible Collateral for repurchase agreements must be Investment Grade securities only or USG securities.} \\[5.5em]
{\color[HTML]{FFFFFF} \textbf{Current Target Return}\textsuperscript{1}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{3m SOFR + 70-72 bps}} \\
{\color[HTML]{FFFFFF} \textbf{Previous Period Return}} & January 18 - April 18 & \textbf{6.00\%} (3m SOFR + 70 bps) \\ 
{\color[HTML]{FFFFFF} \textbf{Current Period Est'd Return}\textsuperscript{2}} & April 18 - July 18 & \textbf{6.03\%}  (3m SOFR + 70 bps) \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
...
{\color[HTML]{FFFFFF} Series / Comparables} & {\color[HTML]{FFFFFF} Return}                & {\color[HTML]{FFFFFF} Spread}               & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}        & {\color[HTML]{FFFFFF} Spread}        & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}       & {\color[HTML]{FFFFFF} Spread}       \\ \arrayrulecolor{light_grey}\hline
	...
	\textbf{Lucid Prime - Series Q1}                    & \textbf{6.00\%}                              & \textbf{-}                                  & \textbf{6.11\%}                               & \textbf{-}                           & \textbf{6.11\%}                             & \textbf{-}                          \\
...
Series Inception & April 16, 2020\\ \arrayrulecolor{light_grey}\hline
\end{tabular}
...
US Govt/AAA Repo & 24.88\% & 113.47\% \\
IG Repo: AA to A & 26.3\% & 121.3\% \\
		IG Repo: BBB & 35.3\% & 132.9\% \\
		Repo: BB & - & - \\
T-Bills; Gov't MMF & 13.47\% & - \\ \cline{2-2} \cline{3-3} 
\textbf{Total} & 100.0\% & \textbf{123.77\%} \\\arrayrulecolor{light_grey}\hline
\end{tabular}
...
%     bottom color=transparent!0]
	...
	\begin{axis}[
		...
		date coordinates in=x, date ZERO=2020-07-16,
	...
	\addplot[ybar, nodes near coords, fill=lucid_blue, rounded corners=1pt,blur shadow={shadow yshift=-1pt, shadow xshift=1pt}] 
		coordinates {
			(2021-04-15, 1.10) (2021-07-15, 0.89) (2021-10-14, 0.65) (2022-01-13, 0.58) (2022-04-14, 0.69) (2022-07-14, 1.46) (2022-10-13, 2.92) (2023-01-12, 4.42) (2023-04-13, 5.33) (2023-07-20, 5.71) (2023-10-19, 6.05) (2024-01-18, 6.10) (2024-04-18, 6.00)
		};
	...
	\legend{\hphantom{A}Prime Series Q1,\hphantom{A}3m SOFR,\hphantom{A}3m A1/P1 CP}
	\end{axis}
		\end{tikzpicture}}
