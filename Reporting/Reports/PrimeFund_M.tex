...
{\color[HTML]{FFFFFF} Series / Comparables} & {\color[HTML]{FFFFFF} Return}                & {\color[HTML]{FFFFFF} Spread}               & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}        & {\color[HTML]{FFFFFF} Spread}        & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}       & {\color[HTML]{FFFFFF} Spread}       \\ \arrayrulecolor{light_grey}\hline
	...
	\textbf{Lucid Prime - Series M}                    & \textbf{5.82\%}                              & \textbf{-}                                  & \textbf{5.85\%}                               & \textbf{-}                           & \textbf{5.97\%}                             & \textbf{-}                          \\
...
US Govt/AAA Repo & 38.36\% & 116.73\% \\
IG Repo: AA to A & 34.6\% & 123.6\% \\
		IG Repo: BBB & 17.1\% & 128.5\% \\
		Repo: BB & - & - \\
T-Bills; Gov't MMF & 9.93\% & - \\ \cline{2-2} \cline{3-3} 
\textbf{Total} & 100.0\% & \textbf{121.61\%} \\\arrayrulecolor{light_grey}\hline
\end{tabular}
