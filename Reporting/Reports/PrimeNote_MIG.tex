...
{\color[HTML]{FFFFFF}} & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}                & {\color[HTML]{FFFFFF} Spread}               & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}        & {\color[HTML]{FFFFFF} Spread}        & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}       & {\color[HTML]{FFFFFF} Spread}       \\ \arrayrulecolor{light_grey}\hline
	...
	\textbf{Lucid Prime - Series MIG-3}                    & \textbf{5.92\%}                              & \textbf{-}                                  & \textbf{5.85\%}                               & \textbf{-}                           & \textbf{5.97\%}                             & \textbf{-}                          \\
1m SOFR                       & 5.32\%                                       & \textbf{+60 bps}                            & 5.35\%                               & \textbf{+50 bps}                     & 5.44\%                              & \textbf{+53 bps}                    \\
1m A1/P1 CP                       & 5.32\%                                       & \textbf{+60 bps}                           & 5.34\%                               & \textbf{+51 bps}                     & 5.43\%                              & \textbf{+54 bps}                    \\
1m T-Bill                       & 5.27\%                                       & \textbf{+65 bps}                            & 5.31\%                               & \textbf{+54 bps}                     & 5.38\%                              & \textbf{+59 bps}                    \\ \arrayrulecolor{light_grey}\hline
...
\adjustbox{valign=t}{\begin{minipage}[t]{15cm}
		...
		US Govt/AAA Repo & 28.6\% & 114.9\% \\
		IG Repo: AA to A & 27.6\% & 122.3\% \\
		IG Repo: BBB & 40.9\% & 128.0\% \\
		Repo: BB & - & - \\
		T-Bills; Gov't MMF & 3.0\% & - \\ \cline{2-2} \cline{3-3} 
		\textbf{Total} & 100.0\% & \textbf{122.5\%} \\\arrayrulecolor{light_grey}\hline
		\end{tabular}
