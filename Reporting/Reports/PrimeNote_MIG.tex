...
{\color[HTML]{FFFFFF} \textbf{Previous Coupon Period}} & May 16 - June 13 & \textbf{5.92\%} (1m SOFR + 60 bps) \\
{\color[HTML]{FFFFFF} \textbf{Current Period Est'd Coupon}\textsuperscript{2}} & June 13 - July 18 & \textbf{5.92\%}  (1m SOFR + 59 bps) \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
\end{center}
...
{\color[HTML]{FFFFFF}} & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}                & {\color[HTML]{FFFFFF} Spread}               & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}        & {\color[HTML]{FFFFFF} Spread}        & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}       & {\color[HTML]{FFFFFF} Spread}       \\ \arrayrulecolor{light_grey}\hline
	...
	\textbf{Lucid Prime - Series MIG-3}                    & \textbf{5.92\%}                              & \textbf{-}                                  & \textbf{5.96\%}                               & \textbf{-}                           & \textbf{6.08\%}                             & \textbf{-}                          \\
1m SOFR                       & 5.32\%                                       & \textbf{+60 bps}                            & 5.35\%                               & \textbf{+61 bps}                     & 5.44\%                              & \textbf{+64 bps}                    \\
1m A1/P1 CP                       & 5.32\%                                       & \textbf{+60 bps}                           & 5.34\%                               & \textbf{+62 bps}                     & 5.43\%                              & \textbf{+65 bps}                    \\
1m T-Bill                       & 5.27\%                                       & \textbf{+65 bps}                            & 5.31\%                               & \textbf{+65 bps}                     & 5.38\%                              & \textbf{+70 bps}                    \\ \arrayrulecolor{light_grey}\hline
...
\end{tabular}
	...
	\begin{axis}[
		...
		ymin=3, ymax=6.92, %MAXRETURN HERE
...
\adjustbox{valign=t}{\begin{minipage}[t]{15cm}
		...
		US Govt/AAA Repo & 25.1\% & 116.8\% \\
		IG Repo: AA to A & 22.5\% & 119.9\% \\
		IG Repo: BBB & 42.4\% & 127.9\% \\
		Repo: BB & - & - \\
		T-Bills; Gov't MMF & 10.0\% & - \\ \cline{2-2} \cline{3-3} 
		\textbf{Total} & 100.0\% & \textbf{122.8\%} \\\arrayrulecolor{light_grey}\hline
		\end{tabular}
...
\textbf{Related Fund Series Size} & \textbf{\$744.0 million} & Issuing \& Paying Agent & Bank of NY Mellon \\ 
...
{\color[HTML]{FFFFFF} \textbf{Current Principal}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{\$389.8 million}} \\
...
12/14/23 &\textbf{01/18/24} &\textbf{5.96\%} &1m SOFR+60 &\$389,750,000 &\$2,258,384.72 &01/18/24 &\$389,750,000 &125.09\% \\
01/18/24 &\textbf{02/15/24} &\textbf{5.93\%} &1m SOFR+60 &\$389,750,000 &\$1,797,613.61 &02/15/24 &\$389,750,000 &125.54\% \\
02/15/24 &\textbf{03/14/24} &\textbf{5.92\%} &1m SOFR+60 &\$389,750,000 &\$1,794,582.22 &03/14/24 &\$389,750,000 &124.29\% \\
03/14/24 &\textbf{04/18/24} &\textbf{5.93\%} &1m SOFR+60 &\$389,750,000 &\$2,247,017.01 &04/18/24 &\$389,750,000 &124.30\% \\
04/18/24 &\textbf{05/16/24} &\textbf{5.92\%} &1m SOFR+60 &\$389,750,000 &\$1,794,582.22 &05/16/24 &\$389,750,000 &124.86\% \\
05/16/24 &\textbf{06/13/24} &\textbf{5.92\%} &1m SOFR+60 &\$389,750,000 &\$1,794,582.22 &06/13/24 &\$389,750,000 &123.15\% \\
06/13/24 &\textbf{07/18/24} &\textbf{5.92\%{\tiny (Est'd)}} &1m SOFR+59 &\$389,750,000 &n/a &07/18/24 &\$389,750,000 &n/a \\
