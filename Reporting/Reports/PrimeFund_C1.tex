...
{\color[HTML]{FFFFFF} \textbf{Previous Period Return}} & May 16, 2024 - June 13, 2024 & \textbf{5.82\%} (1m SOFR + 50 bps) \\ 
{\color[HTML]{FFFFFF} \textbf{Current Period Est'd Return}\textsuperscript{2}} & June 13, 2024 - July 18, 2024 & \textbf{5.82\%}  (1m SOFR + 49 bps) \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
...
US Govt/AAA Repo & 39.65\% & 116.20\% \\
IG Repo: AA to A & 34.7\% & 123.4\% \\
		IG Repo: BBB & 16.5\% & 129.8\% \\
		Repo: BB & - & - \\
T-Bills; Gov't MMF & 9.08\% & - \\ \cline{2-2} \cline{3-3} 
\textbf{Total} & 100.0\% & \textbf{121.44\%} \\\arrayrulecolor{light_grey}\hline
\end{tabular}
