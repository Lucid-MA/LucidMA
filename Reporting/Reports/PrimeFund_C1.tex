...
{\color[HTML]{FFFFFF} \textbf{Program Series}} & \multicolumn{2}{p{\halfwidthb}!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{Lucid Test Fund Name - Series M-8}} \\[1.5mm]
{\color[HTML]{FFFFFF} \textbf{Objective and Strategy}} & \multicolumn{2}{p{\halfwidthb}!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF} There is no fund! 

There is no series!} \\[5.5em]
...
{\color[HTML]{FFFFFF} \textbf{Previous Period Return}} & April 18 2024 - May 15 2024 & \textbf{5.55\%} (1m TB + 99 bps) \\ 
{\color[HTML]{FFFFFF} \textbf{Current Period Est'd Return}\textsuperscript{2}} & May 15 2024 - July 13 & \textbf{5.55\%}  (1m TBoo + 99 bps) \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
...
\arrayrulecolor{light_grey}\hline
\rowcolor{lucid_blue} 
{\color[HTML]{FFFFFF} \textbf{Net Returns}\textsuperscript{3}}               & \multicolumn{2}{m{\quarterwidth}!{\color{light_grey}\vrule}}{\cellcolor{lucid_blue}\centering {\color[HTML]{FFFFFF} \textbf{Previous Period}}} & \multicolumn{2}{m{\quarterwidtha}!{\color{light_grey}\vrule}}{\cellcolor{lucid_blue}\centering {\color[HTML]{FFFFFF} \textbf{12 Months}}} & \multicolumn{2}{m{\quarterwidtha}!{\color{light_grey}\vrule}}{\cellcolor{lucid_blue}\centering {\color[HTML]{FFFFFF} \textbf{12 Years}}} \\
\rowcolor{lucid_blue}  
{\color[HTML]{FFFFFF} Series / Comparables} & {\color[HTML]{FFFFFF} Return}                & {\color[HTML]{FFFFFF} Spread}               & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}        & {\color[HTML]{FFFFFF} Spread}        & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}       & {\color[HTML]{FFFFFF} Spread}       \\ \arrayrulecolor{light_grey}\hline
	...
	\textbf{Lucid Prime - Series C1}                    & \textbf{5.82\%}                              & \textbf{-}                                  & \textbf{5.85\%}                               & \textbf{-}                           & \textbf{5.95\%}                             & \textbf{-}                          \\
...
US Govt/AAA Repo & 44.4\% & 117.8\% \\
IG Repo: AA to A & 28.2\% & 123.7\% \\
		IG Repo: BBB & 22.4\% & 128.5\% \\
		Repo: BB & - & - \\
T-Bills; Gov't MMF & 5.1\% & - \\ \cline{2-2} \cline{3-3} 
\textbf{Total} & 100.0\% & \textbf{122.1\%} \\\arrayrulecolor{light_grey}\hline
\end{tabular}
...
%     bottom color=transparent!0]
	...
	\addplot[ybar, nodes near coords, fill=lucid_blue, rounded corners=1pt,blur shadow={shadow yshift=-1pt, shadow xshift=1pt}] 
		coordinates {
			(2023-02-09,4.93) (2023-03-09,5.04) (2023-04-13,5.21) (2023-05-11,5.4) (2023-06-15,5.57) (2023-07-20,5.67) (2023-08-17,5.76) (2023-09-14,5.82) (2023-10-19,5.83) (2023-11-16,5.83) (2023-12-14,5.83) (2024-01-18,5.86) (2024-02-15,5.83) (2024-03-14,5.82) (2024-04-18,5.83) (2024-05-16,5.82) 
		};
	\addplot[draw=dark_red,ultra thick,smooth] 
		coordinates {
			(2023-02-09,4.43) (2023-03-09,4.56) (2023-04-13,4.73) (2023-05-11,4.88) (2023-06-15,5.05) (2023-07-20,5.15) (2023-08-17,5.25) (2023-09-14,5.31) (2023-10-19,5.33) (2023-11-16,5.33) (2023-12-14,5.33) (2024-01-18,5.36) (2024-02-15,5.33) (2024-03-14,5.32) (2024-04-18,5.33) (2024-05-16,5.32) 
		};
	\addplot[draw=dark_color,ultra thick,smooth] 
		coordinates {
			(2023-02-09,4.32) (2023-03-09,4.47) (2023-04-13,4.62) (2023-05-11,4.81) (2023-06-15,4.94) (2023-07-20,5.15) (2023-08-17,5.16) (2023-09-14,5.28) (2023-10-19,5.33) (2023-11-16,5.32) (2023-12-14,5.32) (2024-01-18,5.36) (2024-02-15,5.33) (2024-03-14,5.34) (2024-04-18,5.3) (2024-05-16,5.33) 
		};
