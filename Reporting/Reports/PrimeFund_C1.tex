...
{\color[HTML]{FFFFFF} \textbf{Previous Period Return}} & June 13 - July 18 & \textbf{5.81\%} (1m SOFR + 48 bps) \\ 
{\color[HTML]{FFFFFF} \textbf{Current Period Est'd Return}\textsuperscript{2}} & July 18 - August 15 & \textbf{5.81\%}  (1m SOFR + 48 bps) \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
...
{\color[HTML]{FFFFFF} Series / Comparables} & {\color[HTML]{FFFFFF} Return}                & {\color[HTML]{FFFFFF} Spread}               & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}        & {\color[HTML]{FFFFFF} Spread}        & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}       & {\color[HTML]{FFFFFF} Spread}       \\ \arrayrulecolor{light_grey}\hline
	...
	\textbf{Lucid Prime - Series C1}                    & \textbf{5.81\%}                              & \textbf{-}                                  & \textbf{5.84\%}                               & \textbf{-}                           & \textbf{5.98\%}                             & \textbf{-}                          \\
...
US Govt/AAA Repo & 51.0\% & 118.5\% \\
IG Repo: AA to A & 22.8\% & 118.9\% \\
		IG Repo: BBB & 22.2\% & 127.6\% \\
		Repo: BB & - & - \\
T-Bills; Gov't MMF & 4.0\% & - \\ \cline{2-2} \cline{3-3} 
\textbf{Total} & 100.0\% & \textbf{120.7\%} \\\arrayrulecolor{light_grey}\hline
\end{tabular}
...
%     bottom color=transparent!0]
	...
	\begin{axis}[
		...
		date coordinates in=x, date ZERO=2023-04-13,
	...
	\addplot[ybar, nodes near coords, fill=lucid_blue, rounded corners=1pt,blur shadow={shadow yshift=-1pt, shadow xshift=1pt}] 
		coordinates {
			(2023-04-13, 5.21) (2023-05-11, 5.40) (2023-06-15, 5.57) (2023-07-20, 5.67) (2023-08-17, 5.76) (2023-09-14, 5.82) (2023-10-19, 5.83) (2023-11-16, 5.83) (2023-12-14, 5.83) (2024-01-18, 5.86) (2024-02-15, 5.83) (2024-03-14, 5.82) (2024-04-18, 5.83) (2024-05-16, 5.82) (2024-06-13, 5.82) (2024-07-18, -1028.57)
		};
