...
{\color[HTML]{FFFFFF} Series / Comparables} & {\color[HTML]{FFFFFF} Return}                & {\color[HTML]{FFFFFF} Spread}               & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}        & {\color[HTML]{FFFFFF} Spread}        & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}       & {\color[HTML]{FFFFFF} Spread}       \\ \arrayrulecolor{light_grey}\hline
	...
	\textbf{Lucid Prime - Series C1}                    & \textbf{5.82\%}                              & \textbf{-}                                  & \textbf{5.85\%}                               & \textbf{-}                           & \textbf{5.98\%}                             & \textbf{-}                          \\
1m SOFR                       & 5.32\%                                       & \textbf{+50 bps}                            & 5.35\%                               & \textbf{+50 bps}                     & 5.44\%                              & \textbf{+54 bps}                    \\
1m A1/P1 CP                       & 5.32\%                                       & \textbf{+50 bps}                           & 5.34\%                               & \textbf{+51 bps}                     & 5.43\%                              & \textbf{+55 bps}                    \\
1m T-Bill                       & 5.27\%                                       & \textbf{+55 bps}                            & 5.31\%                               & \textbf{+54 bps}                     & 5.38\%                              & \textbf{+60 bps}                    \\ \arrayrulecolor{light_grey}\hline
