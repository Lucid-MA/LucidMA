...
{\color[HTML]{FFFFFF} \textbf{Previous Period Return}} & July 18 - August 15 & \textbf{5.81\%} (1m SOFR + 48 bps) \\ 
{\color[HTML]{FFFFFF} \textbf{Current Period Est'd Return}\textsuperscript{2}} & August 15 - September 12 & \textbf{5.82\%}  (1m SOFR + 48 bps) \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
...
1m T-Bill                       & 5.26\%                                       & \textbf{+55 bps}                            & 5.30\%                               & \textbf{+54 bps}                     & 5.41\%                              & \textbf{+58 bps}                    \\ \arrayrulecolor{light_grey}\hline
