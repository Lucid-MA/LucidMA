...
\rhead{Report Date: July 11, 2024}
...
{\color[HTML]{FFFFFF} \textbf{Previous Coupon Period}} & May 16 - June 13 & \textbf{5.82\%} (1m SOFR + 50 bps) \\
{\color[HTML]{FFFFFF} \textbf{Current Period Est'd Coupon}\textsuperscript{2}} & June 13 - July 18 & \textbf{5.82\%}  (1m SOFR + 49 bps) \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
\end{center}
...
{\color[HTML]{FFFFFF}} & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}                & {\color[HTML]{FFFFFF} Spread}               & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}        & {\color[HTML]{FFFFFF} Spread}        & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}       & {\color[HTML]{FFFFFF} Spread}       \\ \arrayrulecolor{light_grey}\hline
	...
	\textbf{Lucid Prime - Series M-2}                    & \textbf{5.82\%}                              & \textbf{-}                                  & \textbf{5.85\%}                               & \textbf{-}                           & \textbf{5.97\%}                             & \textbf{-}                          \\
...
\adjustbox{valign=t}{\begin{minipage}[t]{15cm}
		...
		US Govt/AAA Repo & 49.5\% & 116.7\% \\
		IG Repo: AA to A & 21.4\% & 119.9\% \\
		IG Repo: BBB & 20.3\% & 127.5\% \\
		Repo: BB & - & - \\
		T-Bills; Gov't MMF & 8.8\% & - \\ \cline{2-2} \cline{3-3} 
		\textbf{Total} & 100.0\% & \textbf{119.9\%} \\\arrayrulecolor{light_grey}\hline
		\end{tabular}
...
\textbf{Lucid Prime Program Size} & \textbf{\$3.15 billion} & Collateral Agent & Bank of NY Mellon \\ 
...
{\color[HTML]{FFFFFF} \textbf{Next Notice Date for Redemption}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}July 11, 2024} \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
\end{center}
...
12/14/23 &\textbf{01/18/24} &\textbf{5.86\%} &1m SOFR+50 &\$325,250,000 &\$1,853,021.53 &01/18/24 &\$325,250,000 &121.30\% \\
01/18/24 &\textbf{02/15/24} &\textbf{5.83\%} &1m SOFR+50 &\$325,250,000 &\$1,474,828.06 &02/15/24 &\$325,250,000 &120.48\% \\
02/15/24 &\textbf{03/14/24} &\textbf{5.82\%} &1m SOFR+50 &\$325,250,000 &\$1,472,298.33 &03/14/24 &\$325,250,000 &120.55\% \\
03/14/24 &\textbf{04/18/24} &\textbf{5.83\%} &1m SOFR+50 &\$325,250,000 &\$1,843,535.07 &04/18/24 &\$325,250,000 &119.83\% \\
04/18/24 &\textbf{05/16/24} &\textbf{5.82\%} &1m SOFR+50 &\$325,250,000 &\$1,472,298.33 &05/16/24 &\$325,250,000 &121.27\% \\
05/16/24 &\textbf{06/13/24} &\textbf{5.82\%} &1m SOFR+50 &\$325,250,000 &\$1,472,298.33 &06/13/24 &\$325,250,000 &121.61\% \\
06/13/24 &\textbf{07/18/24} &\textbf{5.82\%{\tiny (Est'd)}} &1m SOFR+49 &\$325,250,000 &n/a &07/18/24 &\$325,250,000 &n/a \\
