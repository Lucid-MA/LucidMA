...
\rhead{Report Date: July 19, 2024}
...
\textbf{Lucid Prime Series M-2 / Note Series M-2}
} \\
...
{\color[HTML]{FFFFFF} \textbf{Rating}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{AA+} by Egan-Jones} \\
{\color[HTML]{FFFFFF} \textbf{Current Target Return of Notes}\textsuperscript{1}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{1m SOFR + 48-50 bps}}\\
{\color[HTML]{FFFFFF} \textbf{Previous Coupon Period}} & June 13 - July 18 & \textbf{5.81\%} (1m SOFR + 48 bps) \\
{\color[HTML]{FFFFFF} \textbf{Current Period Est'd Coupon}\textsuperscript{2}} & July 18 - August 15 & \textbf{5.81\%}  (1m SOFR + 48 bps) \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
\end{center}
...
{\color[HTML]{FFFFFF}} & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}                & {\color[HTML]{FFFFFF} Spread}               & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}        & {\color[HTML]{FFFFFF} Spread}        & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}       & {\color[HTML]{FFFFFF} Spread}       \\ \arrayrulecolor{light_grey}\hline
	...
	\textbf{Lucid Prime - Series M-2}                    & \textbf{5.81\%}                              & \textbf{-}                                  & \textbf{5.84\%}                               & \textbf{-}                           & \textbf{5.98\%}                             & \textbf{-}                          \\
1m SOFR                       & 5.33\%                                       & \textbf{+48 bps}                            & 5.35\%                               & \textbf{+49 bps}                     & 5.46\%                              & \textbf{+52 bps}                    \\
1m A1/P1 CP                       & 5.31\%                                       & \textbf{+50 bps}                           & 5.34\%                               & \textbf{+50 bps}                     & 5.44\%                              & \textbf{+54 bps}                    \\
1m T-Bill                       & 5.26\%                                       & \textbf{+55 bps}                            & 5.30\%                               & \textbf{+54 bps}                     & 5.41\%                              & \textbf{+57 bps}                    \\ \arrayrulecolor{light_grey}\hline
...
\end{tabular}
	...
	\begin{axis}[
		...
		ymin=3, ymax=6.81, %MAXRETURN HERE
	   symbolic x coords={Series M-2,1m SOFR,1m A1/P1 CP,1m T-Bill},
		xtick={Series M-2,1m SOFR,1m A1/P1 CP,1m T-Bill},
...
\adjustbox{valign=t}{\begin{minipage}[t]{15cm}
		...
		\multicolumn{3}{!{\color{light_grey}\vrule}p{8.2cm}!{\color{light_grey}\vrule}}{\rowcolor[HTML]{EFEFEF}{\textbf{Series M}: Secured by \textbf{Highly Rated Investment Grade Collateral securities (at least 75\% must be rated between AAA and A- or USG securities)}, with daily valuations \& margining.}} \\
		& & \\
		 & \textbf{\% Portfolio} & \textbf{O/C Rate}\\
		US Govt/AAA Repo & 49.6\% & 118.2\% \\
		IG Repo: AA to A & 21.7\% & 118.2\% \\
		IG Repo: BBB & 21.3\% & 127.6\% \\
		Repo: BB & - & - \\
		T-Bills; Gov't MMF & 7.4\% & - \\ \cline{2-2} \cline{3-3} 
		\textbf{Total} & 100.0\% & \textbf{120.4\%} \\\arrayrulecolor{light_grey}\hline
		\end{tabular}
...
\textbf{Related Fund Series Size} & \textbf{\$839.4 million} & Issuing \& Paying Agent & Bank of NY Mellon \\ 
\textbf{Lucid Prime Program Size} & \textbf{\$3.2 billion} & Collateral Agent & Bank of NY Mellon \\ 
...
\textbf{M-2} (Secured by related fund series M-2)
} \\
{\color[HTML]{FFFFFF} \textbf{Current Principal}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{\$425.2 million}} \\
{\color[HTML]{FFFFFF} \textbf{Original Issue Date}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}February 09, 2023} \\
{\color[HTML]{FFFFFF} \textbf{Final Maturity Date}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}April 23, 2026} \\
{\color[HTML]{FFFFFF} \textbf{Next Coupon Payment Date}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}August 15, 2024} \\
{\color[HTML]{FFFFFF} \textbf{Next Redemption Date (Put Date)}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{August 15, 2024}} \\
{\color[HTML]{FFFFFF} \textbf{Next Notice Date for Redemption}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}August 08, 2024} \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
\end{center}
...
09/14/23 &\textbf{10/19/23} &\textbf{5.83\%} &1m SOFR+51 &\$205,250,000 &\$1,163,368.40 &10/19/23 &\$205,250,000 &117.0\% \\
10/19/23 &\textbf{11/16/23} &\textbf{5.83\%} &1m SOFR+50 &\$470,250,000 &\$1,112,072.50 &11/16/23 &\$470,250,000 &120.5\% \\
11/16/23 &\textbf{12/14/23} &\textbf{5.83\%} &1m SOFR+50 &\$235,250,000 &\$2,132,322.50 &12/14/23 &\$235,250,000 &123.0\% \\
12/14/23 &\textbf{01/18/24} &\textbf{5.86\%} &1m SOFR+50 &\$385,250,000 &\$2,194,854.86 &01/18/24 &\$385,250,000 &121.5\% \\
01/18/24 &\textbf{02/15/24} &\textbf{5.83\%} &1m SOFR+50 &\$485,250,000 &\$1,746,894.72 &02/15/24 &\$485,250,000 &120.8\% \\
02/15/24 &\textbf{03/14/24} &\textbf{5.82\%} &1m SOFR+50 &\$305,250,000 &\$2,196,565.00 &03/14/24 &\$305,250,000 &120.9\% \\
03/14/24 &\textbf{04/18/24} &\textbf{5.83\%} &1m SOFR+50 &\$335,250,000 &\$1,730,173.96 &04/18/24 &\$335,250,000 &120.5\% \\
04/18/24 &\textbf{05/16/24} &\textbf{5.82\%} &1m SOFR+50 &\$325,250,000 &\$1,517,565.00 &05/16/24 &\$325,250,000 &121.7\% \\
05/16/24 &\textbf{06/13/24} &\textbf{5.82\%} &1m SOFR+50 &\$325,250,000 &\$1,472,298.33 &06/13/24 &\$325,250,000 &122.2\% \\
06/13/24 &\textbf{07/18/24} &\textbf{5.81\%} &1m SOFR+48 &\$425,250,000 &\$1,837,210.76 &07/18/24 &\$425,250,000 &120.4\% \\
07/18/24 &\textbf{08/15/24} &\textbf{5.81\%{\tiny (Est'd)}} &1m SOFR+48 &\$425,250,000 &n/a &08/15/24 &\$425,250,000 &n/a \\
