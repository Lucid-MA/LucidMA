...
\adjustbox{valign=t}{\begin{minipage}[t]{15cm}
		...
		US Govt/AAA Repo & 38.4\% & 118.5\% \\
		IG Repo: AA to A & 34.6\% & 123.2\% \\
		IG Repo: BBB & 17.1\% & 128.4\% \\
		Repo: BB & - & - \\
		T-Bills; Gov't MMF & 9.9\% & - \\ \cline{2-2} \cline{3-3} 
		\textbf{Total} & 100.0\% & \textbf{122.2\%} \\\arrayrulecolor{light_grey}\hline
		\end{tabular}
...
\textbf{Related Fund Series Size} & \textbf{\$719.1 million} & Issuing \& Paying Agent & Bank of NY Mellon \\ 
