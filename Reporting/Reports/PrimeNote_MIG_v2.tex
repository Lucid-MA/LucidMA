...
\rhead{Report Date: August 16, 2024}
...
\textbf{Lucid Prime Series MIG / Note Series MIG-3}
} \\
...
{\color[HTML]{FFFFFF} \textbf{Rating}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{AA+} by Egan-Jones (NAIC 1)} \\
{\color[HTML]{FFFFFF} \textbf{Current Target Return of Notes}\textsuperscript{1}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{1m SOFR + 58-60 bps}}\\
{\color[HTML]{FFFFFF} \textbf{Previous Coupon Period}} & July 18 - August 15 & \textbf{5.910\%} (1m SOFR + 58 bps) \\
{\color[HTML]{FFFFFF} \textbf{Current Period Est'd Coupon}\textsuperscript{2}} & August 15 - September 12 & \textbf{5.917\%}  (1m SOFR + 58 bps) \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
\end{center}
...
{\color[HTML]{FFFFFF}} & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}                & {\color[HTML]{FFFFFF} Spread}               & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}        & {\color[HTML]{FFFFFF} Spread}        & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}       & {\color[HTML]{FFFFFF} Spread}       \\ \arrayrulecolor{light_grey}\hline
	...
	\textbf{Lucid Prime - Series MIG}                    & \textbf{5.91\%}                              & \textbf{-}                                  & \textbf{5.94\%}                               & \textbf{-}                           & \textbf{6.09\%}                             & \textbf{-}                          \\
1m SOFR                       & 5.33\%                                       & \textbf{+58 bps}                            & 5.35\%                               & \textbf{+59 bps}                     & 5.46\%                              & \textbf{+63 bps}                    \\
1m A1/P1 CP                       & 5.32\%                                       & \textbf{+59 bps}                           & 5.34\%                               & \textbf{+60 bps}                     & 5.45\%                              & \textbf{+64 bps}                    \\
1m T-Bill                       & 5.26\%                                       & \textbf{+65 bps}                            & 5.28\%                               & \textbf{+66 bps}                     & 5.41\%                              & \textbf{+68 bps}                    \\ \arrayrulecolor{light_grey}\hline
...
\end{tabular}
	...
	\begin{axis}[
		...
		ymin=3, ymax=6.91, %MAXRETURN HERE
	   symbolic x coords={Series MIG-3,1m SOFR,1m A1/P1 CP,1m T-Bill},
		xtick={Series MIG-3,1m SOFR,1m A1/P1 CP,1m T-Bill},
...
\adjustbox{valign=t}{\begin{minipage}[t]{15cm}
		...
		\renewcommand{\arraystretch}{1.48}\begin{tabular}{!{\color{light_grey}\vrule}
		...
		\multicolumn{3}{!{\color{light_grey}\vrule}p{8.2cm}!{\color{light_grey}\vrule}}{\rowcolor[HTML]{EFEFEF}{\textbf{Series }: Secured by \textbf{Highly Rated Investment Grade Collateral securities}, with daily valuations \& margining.}} \\
		& & \\
		 & \textbf{\% Portfolio} & \textbf{O/C Rate}\\
		US Govt/AAA Repo & 27.2\% & 115.9\% \\
		IG Repo: AA to A & 20.9\% & 120.0\% \\
		IG Repo: BBB & 49.9\% & 127.3\% \\
		Repo: BB & - & - \\
		T-Bills; Gov't MMF & 2.0\% & - \\ \cline{2-2} \cline{3-3} 
		\textbf{Total} & 100.0\% & \textbf{122.6\%} \\\arrayrulecolor{light_grey}\hline
		\end{tabular}
...
\textbf{Related Fund Series Size} & \textbf{\$808.6 million} & Issuing \& Paying Agent & Bank of NY Mellon \\ 
\textbf{Lucid Prime Program Size} & \textbf{\$3.22 billion} & Collateral Agent & Bank of NY Mellon \\ 
\textbf{Lucid Platform AUM} & \textbf{\$4.8 billion} & Auditor & KPMG \\ 
Prime Program Inception & July 20, 2018 & & \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
\end{center}
...
\textbf{MIG-3} (Secured by related fund series MIG)
} \\
{\color[HTML]{FFFFFF} \textbf{Current Principal}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{\$489.8 million}} \\
{\color[HTML]{FFFFFF} \textbf{Original Issue Date}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}October 15, 2020} \\
{\color[HTML]{FFFFFF} \textbf{Final Maturity Date}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}October 22, 2026} \\
{\color[HTML]{FFFFFF} \textbf{Next Coupon Payment Date}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}September 12, 2024} \\
{\color[HTML]{FFFFFF} \textbf{Next Redemption Date (Put Date)}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{September 12, 2024}} \\
{\color[HTML]{FFFFFF} \textbf{Next Notice Date for Redemption}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}September 05, 2024} \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
\end{center}
...
09/14/23 &\textbf{10/19/23} &\textbf{5.93\%} &1m SOFR+62 &\$302,750,000 &\$1,745,437.85 &10/19/23 &\$302,750,000 &126.0\% \\
10/19/23 &\textbf{11/16/23} &\textbf{5.93\%} &1m SOFR+60 &\$337,750,000 &\$1,580,839.17 &11/16/23 &\$337,750,000 &124.1\% \\
11/16/23 &\textbf{12/14/23} &\textbf{5.93\%} &1m SOFR+60 &\$287,750,000 &\$1,511,655.83 &12/14/23 &\$287,750,000 &126.8\% \\
12/14/23 &\textbf{01/18/24} &\textbf{5.96\%} &1m SOFR+60 &\$337,750,000 &\$1,957,073.61 &01/18/24 &\$337,750,000 &125.4\% \\
01/18/24 &\textbf{02/15/24} &\textbf{5.93\%} &1m SOFR+60 &\$337,750,000 &\$1,557,778.06 &02/15/24 &\$337,750,000 &125.9\% \\
02/15/24 &\textbf{03/14/24} &\textbf{5.92\%} &1m SOFR+59 &\$387,750,000 &\$1,555,151.11 &03/14/24 &\$387,750,000 &124.7\% \\
03/14/24 &\textbf{04/18/24} &\textbf{5.93\%} &1m SOFR+60 &\$364,750,000 &\$2,247,017.01 &04/18/24 &\$364,750,000 &124.8\% \\
04/18/24 &\textbf{05/16/24} &\textbf{5.92\%} &1m SOFR+60 &\$339,750,000 &\$1,679,471.11 &05/16/24 &\$339,750,000 &125.3\% \\
05/16/24 &\textbf{06/13/24} &\textbf{5.92\%} &1m SOFR+60 &\$389,750,000 &\$1,794,582.22 &06/13/24 &\$389,750,000 &123.7\% \\
06/13/24 &\textbf{07/18/24} &\textbf{5.91\%} &1m SOFR+58 &\$489,750,000 &\$2,239,438.54 &07/18/24 &\$489,750,000 &123.1\% \\
07/18/24 &\textbf{08/15/24} &\textbf{5.91\%} &1m SOFR+58 &\$489,750,000 &\$2,251,217.50 &08/15/24 &\$489,750,000 &122.6\% \\
08/15/24 &\textbf{09/12/24} &\textbf{5.92\%{\tiny (Est'd)}} &1m SOFR+58 &\$489,750,000 &n/a &09/12/24 &\$489,750,000 &n/a \\
