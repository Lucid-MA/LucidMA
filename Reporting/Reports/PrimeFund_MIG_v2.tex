...
{\color[HTML]{FFFFFF} \textbf{Program Series}} & \multicolumn{2}{p{\halfwidthb}!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{Lucid Prime - Series MIG}} \\[1.5mm]
...
\textbf{{Series MIG}} interests have (i) maximum maturities of 1 month on all series assets, (ii) monthly withdrawal dates and (iii) all Eligible Collateral for repurchase agreements must be Investment Grade securities only or USG securities.} \\[5.5em]
{\color[HTML]{FFFFFF} \textbf{Current Target Return}\textsuperscript{1}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{1m SOFR + 58-60 bps}} \\
{\color[HTML]{FFFFFF} \textbf{Previous Period Return}} & July 18 - August 15 & \textbf{5.910\%} (1m SOFR + 58 bps) \\ 
{\color[HTML]{FFFFFF} \textbf{Current Period Est'd Return}\textsuperscript{2}} & August 15 - September 12 & \textbf{5.917\%}  (1m SOFR + 58 bps) \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
...
Series Inception & October 15, 2020\\ \arrayrulecolor{light_grey}\hline
\end{tabular}
...
%     bottom color=transparent!0]
	...
	\addplot[ybar, nodes near coords, fill=lucid_blue, rounded corners=1pt,blur shadow={shadow yshift=-1pt, shadow xshift=1pt}] 
		coordinates {
			(2023-05-11, 5.51) (2023-06-15, 5.68) (2023-07-20, 5.78) (2023-08-17, 5.87) (2023-09-14, 5.93) (2023-10-19, 5.93) (2023-11-16, 5.93) (2023-12-14, 5.93) (2024-01-18, 5.96) (2024-02-15, 5.93) (2024-03-14, 5.92) (2024-04-18, 5.93) (2024-05-16, 5.92) (2024-06-13, 5.92) (2024-07-18, 5.91) (2024-08-15, 5.91)
		};
	...
	\legend{\hphantom{A}Prime Series MIG,\hphantom{A}1m SOFR,\hphantom{A}1m A1/P1 CP}
	\end{axis}
		\end{tikzpicture}}
