...
{\color[HTML]{FFFFFF} \textbf{Previous Coupon Period}} & June 13 - July 18 & \textbf{5.52\%} (1m TB + 19 bps) \\
{\color[HTML]{FFFFFF} \textbf{Current Period Est'd Coupon}\textsuperscript{2}} & July 18 - August 15 & \textbf{5.52\%}  (1m TB + 19 bps) \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
\end{center}
...
{\color[HTML]{FFFFFF}} & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}                & {\color[HTML]{FFFFFF} Spread}               & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}        & {\color[HTML]{FFFFFF} Spread}        & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}       & {\color[HTML]{FFFFFF} Spread}       \\ \arrayrulecolor{light_grey}\hline
	...
	\textbf{Lucid USG - Series M-8}                    & \textbf{5.52\%}                              & \textbf{-}                                  & \textbf{5.55\%}                               & \textbf{-}                           & \textbf{5.66\%}                             & \textbf{-}                          \\
1m T-Bill                       & 5.33\%                                       & \textbf{+19 bps}                            & 5.37\%                               & \textbf{+18 bps}                     & 5.48\%                              & \textbf{+18 bps}                    \\
Crane Govt MM Index                       & 5.11\%                                       & \textbf{+41 bps}                           & 5.13\%                               & \textbf{+42 bps}                     & 5.24\%                              & \textbf{+42 bps}                    \\ \arrayrulecolor{light_grey}\hline
...
\adjustbox{valign=t}{\begin{minipage}[t]{15cm}
		...
		T-Bills; Gov't MMF & 3.6\% & - \\ \cline{2-2} \cline{3-3} 
		\textbf{Total} & 100.0\% & \textbf{107.3\%} \\\arrayrulecolor{light_grey}\hline
		\end{tabular}
...
\textbf{Related Fund Series Size} & \textbf{\$117.3 million} & Issuing \& Paying Agent & Bank of NY Mellon \\ 
\textbf{Lucid USG Program Size} & \textbf{\$117.3 million} & Collateral Agent & Bank of NY Mellon \\ 
...
{\color[HTML]{FFFFFF} \textbf{Next Notice Date for Redemption}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}August 12, 2024} \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
\end{center}
...
07/18/24 &\textbf{08/15/24} &\textbf{5.52\%{\tiny (Est'd)}} &1m TB+19 &\$20,700,000 &n/a &08/15/24 &\$20,700,000 &1000000.0\% \\
