...
{\color[HTML]{FFFFFF} \textbf{Previous Coupon Period}} & April 18, 2024 - May 16, 2024 & \textbf{5.45\%} (1m TB + 18 bps) \\
{\color[HTML]{FFFFFF} \textbf{Current Period Est'd Coupon}\textsuperscript{2}} & May 16, 2024 - June 13, 2024 & \textbf{5.52\%}  (1m TB + 19 bps) \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
\end{center}
...
{\color[HTML]{FFFFFF}} & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}                & {\color[HTML]{FFFFFF} Spread}               & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}        & {\color[HTML]{FFFFFF} Spread}        & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}       & {\color[HTML]{FFFFFF} Spread}       \\ \arrayrulecolor{light_grey}\hline
	...
	\textbf{Lucid USG - Series M-8}                    & \textbf{5.45\%}                              & \textbf{-}                                  & \textbf{5.55\%}                               & \textbf{-}                           & \textbf{5.63\%}                             & \textbf{-}                          \\
...
\adjustbox{valign=t}{\begin{minipage}[t]{15cm}
		...
		US Govt Repo & 0.9547680116196531 & 1.0608547801538135 \\
		T-Bills; Gov't MMF & 0.045231988380346935 & - \\ \cline{2-2} \cline{3-3} 
		\textbf{Total} & 100.0\% & \textbf{1.0608547801538135} \\\arrayrulecolor{light_grey}\hline
		\end{tabular}
...
USG Program Inception & June 29 1990 & & \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
\end{center}
...
{\color[HTML]{FFFFFF} \textbf{Original Issue Date}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}December 14, 1990} \\
{\color[HTML]{FFFFFF} \textbf{Final Maturity Date}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}December 14, 2023} \\
{\color[HTML]{FFFFFF} \textbf{Next Coupon Payment Date}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}December 31, 2099} \\
{\color[HTML]{FFFFFF} \textbf{Next Redemption Date (Put Date)}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{December 31, 2099}} \\
{\color[HTML]{FFFFFF} \textbf{Next Notice Date for Redemption}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}June 10, 9999} \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
\end{center}
