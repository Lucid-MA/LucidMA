...
\rhead{Report Date: June 05, 2024}
...
\textbf{Lucid Prime Series M / Note Series M-2}
} \\
...
{\color[HTML]{FFFFFF} \textbf{Current Target Return of Notes}\textsuperscript{1}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{1m SOFR + 50-52 bps}}\\
{\color[HTML]{FFFFFF} \textbf{Previous Coupon Period}} & Apr 18 - May 16 & \textbf{5.82\%} (1m SOFR + 50 bps) \\
{\color[HTML]{FFFFFF} \textbf{Current Period Est'd Coupon}\textsuperscript{2}} & May 16 - Jun 13 & \textbf{5.82\%}  (1m SOFR + 50 bps) \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
\end{center}
...
{\color[HTML]{FFFFFF}} & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}                & {\color[HTML]{FFFFFF} Spread}               & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}        & {\color[HTML]{FFFFFF} Spread}        & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}       & {\color[HTML]{FFFFFF} Spread}       \\ \arrayrulecolor{light_grey}\hline
	...
	\textbf{Lucid Prime - Series M}                    & \textbf{5.82\%}                              & \textbf{-}                                  & \textbf{5.85\%}                               & \textbf{-}                           & \textbf{5.95\%}                             & \textbf{-}                          \\
1m SOFR                       & 5.32\%                                       & \textbf{+50 bps}                            & 5.35\%                               & \textbf{+50 bps}                     & 5.41\%                              & \textbf{+54 bps}                    \\
1m A1/P1 CP                       & 5.33\%                                       & \textbf{+49 bps}                           & 5.35\%                               & \textbf{+50 bps}                     & 5.39\%                              & \textbf{+56 bps}                    \\
1m T-Bills                       & 5.30\%                                       & \textbf{+52 bps}                            & 5.32\%                               & \textbf{+53 bps}                     & 5.36\%                              & \textbf{+59 bps}                    \\ \arrayrulecolor{light_grey}\hline
...
\end{tabular}
	...
	\begin{axis}[
		...
		ymin=3, ymax=6.82, %MAXRETURN HERE
	   symbolic x coords={Series M-2,1m SOFR,1m A1/P1 CP,1m T-Bills},
		xtick={Series M-2,1m SOFR,1m A1/P1 CP,1m T-Bills},
...
\adjustbox{valign=t}{\begin{minipage}[t]{15cm}
		...
		US Govt/AAA Repo & 46.0\% & 117.5\% \\
		IG Repo: AA to A & 28.5\% & 123.8\% \\
		IG Repo: BBB & 21.4\% & 128.6\% \\
		Repo: BB & - & - \\
		T-Bills; Gov't MMF & 4.1\% & - \\ \cline{2-2} \cline{3-3} 
		\textbf{Total} & 100.0\% & \textbf{121.8\%} \\\arrayrulecolor{light_grey}\hline
		\end{tabular}
...
\textbf{Related Fund Series Size} & \textbf{\$768.3 million} & Issuing \& Paying Agent & Bank of NY Mellon \\ 
\textbf{Lucid Prime Program Size} & \textbf{\$3.03 billion} & Collateral Agent & Bank of NY Mellon \\ 
\textbf{Lucid Platform AUM} & \textbf{\$4.65 billion} & Auditor & KPMG \\ 
...
\textbf{M-2} (Secured by related fund series M)
} \\
{\color[HTML]{FFFFFF} \textbf{Current Principal}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{\$325.2 million}} \\
...
{\color[HTML]{FFFFFF} \textbf{Next Coupon Payment Date}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}June 13, 2024} \\
{\color[HTML]{FFFFFF} \textbf{Next Redemption Date (Put Date)}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{June 13, 2024}} \\
{\color[HTML]{FFFFFF} \textbf{Next Notice Date for Redemption}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}June 06, 2024} \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
\end{center}
