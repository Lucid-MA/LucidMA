...
# Select the required columns
df = df[['Start_date', 'End_date', 'PoolDescription','InvestorDescription', 'Revised Beginning Cap Balance', 'Withdrawal - BOP',
...
df_result = pd.DataFrame(
    columns=['Start_date', 'End_date', 'Day_counts', 'Pool_name' ,'Investor_name', 'Relevant returns', 'Calculated returns'])
