...
year_threshold = current_year - 1  # 2021 or older
                    ...
                    with zipfile.ZipFile(zip_path, 'r') as zip_ref:
                        for inner_file in zip_ref.namelist():
                            if target_filename_pattern in inner_file:
                                ...
                                new_filename = f"{new_filename}_{postfix}.xlsx"
...
# Print the list of relevant filenames
print(relevant_filenames)
df = pd.read_excel(relevant_filenames[0])
print(df.head())