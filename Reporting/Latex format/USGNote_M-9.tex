...
\rhead{Report Date: April 18, 2024}
...
{\color[HTML]{FFFFFF} \textbf{Current Target Return of Notes}\textsuperscript{1}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{1m T-Bills + 15-20 bps}}\\
{\color[HTML]{FFFFFF} \textbf{Previous Coupon Period}} & Mar 14 - Apr 18 & \textbf{5.53\%} (1m TB + 17 bps) \\
{\color[HTML]{FFFFFF} \textbf{Current Period Est'd Coupon}\textsuperscript{2}} & Apr 18 - May 16 & \textbf{5.53\%}  (1m TB + 16 bps) \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
\end{center}
...
{\color[HTML]{FFFFFF}} & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}                & {\color[HTML]{FFFFFF} Spread}               & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}        & {\color[HTML]{FFFFFF} Spread}        & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}       & {\color[HTML]{FFFFFF} Spread}       \\ \arrayrulecolor{light_grey}\hline
	...
	\textbf{Lucid USG - Series M}                    & \textbf{5.53\%}                              & \textbf{-}                                  & \textbf{5.56\%}                               & \textbf{-}                           & \textbf{5.56\%}                             & \textbf{-}                          \\
1m T-Bills                       & 5.36\%                                       & \textbf{+17 bps}                            & 5.38\%                               & \textbf{+18 bps}                     & 5.32\%                              & \textbf{+24 bps}                    \\
Crane Govt MM Index                       & 5.12\%                                       & \textbf{+41 bps}                           & 5.14\%                               & \textbf{+42 bps}                     & 5.16\%                              & \textbf{+40 bps}                    \\ \arrayrulecolor{light_grey}\hline
...
\end{tabular}
	...
	\begin{axis}[
	   ...
	   symbolic x coords={Series M-9,1m T-Bills,Crane Govt},
		xtick={Series M-9,1m T-Bills,Crane Govt},
...
\textbf{Related Fund Series Size} & \textbf{\$122.9 million} & Issuing \& Paying Agent & Bank of NY Mellon \\ 
\textbf{Lucid USG Program Size} & \textbf{\$122.9 million} & Collateral Agent & Bank of NY Mellon \\ 
\textbf{Lucid Platform AUM} & \textbf{\$4.83 billion} & Auditor & KPMG \\ 
...
{\color[HTML]{FFFFFF} \textbf{Next Notice Date for Redemption}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}May 13, 2024} \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
\end{center}
...
02/15/24 &\textbf{{03/14/24}} &\textbf{{5.53\%}} &1m TB+17 &\$20,700,000 &\$212,109.59 &03/14/24 &\$20,700,000 &107.0\% \\03/14/24 &\textbf{{04/18/24}} &\textbf{{5.53\%}} &1m TB+16 &\hphantom{{\$}}50,000,000 &\hphantom{{\$}}212,109.59 &04/18/24 &\hphantom{{\$}}50,000,000 &107.0\% \\04/18/24 &\textbf{{05/16/24}} &\textbf{{5.53\%{{\tiny (Est'd)}}}} &1m TB+16 &\hphantom{{\$}}50,000,000 &\hphantom{{\$}}n/a &05/16/24 &\hphantom{{\$}}50,000,000 &n/a \\
		& & & & & & & &      \\ 
