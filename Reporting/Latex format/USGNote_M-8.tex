...
{\color[HTML]{FFFFFF} \textbf{Previous Coupon Period}} & Feb 15 - Mar 14 & \textbf{5.53\%} (1m TB + 17 bps) \\
{\color[HTML]{FFFFFF} \textbf{Current Period Est'd Coupon}\textsuperscript{2}} & Mar 14 - Apr 18 & \textbf{5.53\%}  (1m TB + 16 bps) \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
\end{center}
...
\begin{axis}[
    ...
    ymin=2, ymax=5.6000000000000005, %MAXRETURN HERE
...
{\color[HTML]{FFFFFF} \textbf{Next Notice Date for Redemption}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}April 15, 2024} \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
\end{center}
