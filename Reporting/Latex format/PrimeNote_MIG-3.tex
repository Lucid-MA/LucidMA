...
%\cline{2-3}
                                             ...
                                             {\color[HTML]{FFFFFF} \textbf{Previous Coupon Period}}                         & Feb 15 - Mar 14                                                                         & \textbf{5.92\%} (1m SOFR + 60 bps) \\
                                             {\color[HTML]{FFFFFF} \textbf{Current Period Est'd Coupon}\textsuperscript{2}} & Mar 14 - Apr 18 & \textbf{5.93\%}  (1m SOFR + 60 bps) \\ \arrayrulecolor{light_grey}\hline
        \end{tabular}
    \end{center}
    ...
    \noindent\renewcommand{\arraystretch}{1.3}\begin{tabular}{!{\color{light_grey}\vrule}m{5.2cm}!{\color{light_grey}\vrule}m{\eighthwidth}c!{\color{light_grey}\vrule}m{\eighthwidtha}c!{\color{light_grey}\vrule}m{\eighthwidtha}c!{\color{light_grey}\vrule}}
                                                  ...
                                                  \textbf{Lucid Prime - Series MIG} & \textbf{5.92\%}                                  & \textbf{-}                    & \textbf{5.97\%}                                  & \textbf{-}                           & \textbf{n/a}                             & \textbf{-}                          \\
                                                  1m SOFR                           & 5.32\%                                           & \textbf{+60 bps}              & 5.36\%                                           & \textbf{+61 bps}              & n/a                                              & \textbf{n/a}                  \\
                                                  1m A1/P1 CP                       & 5.34\%                                           & \textbf{+57 bps}              & 5.37\%                                           & \textbf{+60 bps}              & n/a                                              & \textbf{n/a}                  \\
                                                  1m T-Bills                        & 5.29\%                                           & \textbf{+63 bps}              & 5.30\%                                           & \textbf{+67 bps}              & n/a                                              & \textbf{n/a}                  \\ \arrayrulecolor{light_grey}\hline
    ...
    \noindent\adjustbox{valign=t}{\begin{minipage}{9.5cm}
                                      ...
                                      \hspace*{-0.86cm}\resizebox {!} {6.676cm} {\begin{tikzpicture}
                                                                                     \begin{axis}[
                                                                                         ...
                                                                                         ymin=3, ymax=6.42, %MAXRETURN HERE
    ...
    \adjustbox{valign=t}{\begin{minipage}[t]{15cm}
                             ...
                             \renewcommand{\arraystretch}{1.48}\begin{tabular}{!{\color{light_grey}\vrule}
                                     ...
                                     >{\columncolor[HTML]{EFEFEF}}c!{\color{light_grey}\vrule}}
                                                                   ...
                                                                   Repo: BB           & -                     & -                 \\
                                                                   T-Bills; Gov't MMF & 1.4\%                 & -                 \\ \cline{2-2} \cline{3-3}
...
%\cline{2-3}
                                                      ...
                                                      {\color[HTML]{FFFFFF} \textbf{Current Principal}}               & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{\$387.8 million}} \\
                                                      ...
                                                      {\color[HTML]{FFFFFF} \textbf{Next Coupon Payment Date}}        & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}April 18, 2024} \\
                                                      {\color[HTML]{FFFFFF} \textbf{Next Redemption Date (Put Date)}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{April 18, 2024}} \\
                                                      {\color[HTML]{FFFFFF} \textbf{Next Notice Date for Redemption}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}April 11, 2024}           \\ \arrayrulecolor{light_grey}\hline
        \end{tabular}
    \end{center}
