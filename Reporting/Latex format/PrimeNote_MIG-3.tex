...
\rhead{Report Date: April 19, 2024}
...
{\color[HTML]{FFFFFF} \textbf{Previous Coupon Period}} & Mar 14 - Apr 18 & \textbf{5.93\%} (1m SOFR + 60 bps) \\
{\color[HTML]{FFFFFF} \textbf{Current Period Est'd Coupon}\textsuperscript{2}} & Apr 18 - May 16 & \textbf{5.92\%}  (1m SOFR + 60 bps) \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
\end{center}
...
{\color[HTML]{FFFFFF}} & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}                & {\color[HTML]{FFFFFF} Spread}               & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}        & {\color[HTML]{FFFFFF} Spread}        & {\color[HTML]{FFFFFF} Return\textsuperscript{1}}       & {\color[HTML]{FFFFFF} Spread}       \\ \arrayrulecolor{light_grey}\hline
	...
	\textbf{Lucid Prime - Series MIG}                    & \textbf{5.93\%}                              & \textbf{-}                                  & \textbf{5.92\%}                               & \textbf{-}                           & \textbf{6.02\%}                             & \textbf{-}                          \\
1m SOFR                       & 5.33\%                                       & \textbf{+60 bps}                            & 5.35\%                               & \textbf{+56 bps}                     & 5.38\%                              & \textbf{+64 bps}                    \\
1m A1/P1 CP                       & 5.30\%                                       & \textbf{+63 bps}                           & 5.35\%                               & \textbf{+56 bps}                     & 5.35\%                              & \textbf{+67 bps}                    \\
1m T-Bills                       & 5.30\%                                       & \textbf{+63 bps}                            & 5.31\%                               & \textbf{+61 bps}                     & 5.25\%                              & \textbf{+77 bps}                    \\ \arrayrulecolor{light_grey}\hline
...
\end{tabular}
	...
	\begin{axis}[
		...
		ymin=3, ymax=6.83, %MAXRETURN HERE
...
\adjustbox{valign=t}{\begin{minipage}[t]{15cm}
		...
		US Govt/AAA Repo & 16.7\% & 113.3\% \\
		IG Repo: AA to A & 32.1\% & 122.3\% \\
		IG Repo: BBB & 46.5\% & 127.5\% \\
		Repo: BB & - & - \\
		T-Bills; Gov't MMF & 4.7\% & - \\ \cline{2-2} \cline{3-3} 
		\textbf{Total} & 100.0\% & \textbf{124.6\%} \\\arrayrulecolor{light_grey}\hline
		\end{tabular}
...
\textbf{Related Fund Series Size} & \textbf{\$653.3 million} & Issuing \& Paying Agent & Bank of NY Mellon \\ 
\textbf{Lucid Prime Program Size} & \textbf{\$3.17 billion} & Collateral Agent & Bank of NY Mellon \\ 
\textbf{Lucid Platform AUM} & \textbf{\$4.78 billion} & Auditor & KPMG \\ 
...
{\color[HTML]{FFFFFF} \textbf{Current Principal}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{\$364.8 million}} \\
...
{\color[HTML]{FFFFFF} \textbf{Next Coupon Payment Date}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}May 16, 2024} \\
{\color[HTML]{FFFFFF} \textbf{Next Redemption Date (Put Date)}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{May 16, 2024}} \\
{\color[HTML]{FFFFFF} \textbf{Next Notice Date for Redemption}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}May 09, 2024} \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
\end{center}
