...
{\color[HTML]{FFFFFF} \textbf{Previous Coupon Period}} & Feb 15 - Mar 14 & \textbf{5.82\%} (1m SOFR + 50 bps) \\
{\color[HTML]{FFFFFF} \textbf{Current Period Est'd Coupon}\textsuperscript{2}} & Mar 14 - Apr 18 & \textbf{5.83\%}  (1m SOFR + 50 bps) \\ \arrayrulecolor{light_grey}\hline
\end{tabular}
\end{center}
...
1m SOFR                       & 5.32\%                                       & \textbf{+50 bps}                            & 5.36\%                               & \textbf{+51 bps}                     & 5.32\%                              & \textbf{+53 bps}                    \\
1m A1/P1 CP                       & 5.34\%                                       & \textbf{+48 bps}                           & 5.37\%                               & \textbf{+50 bps}                     & 5.28\%                              & \textbf{+56 bps}                    \\
1m T-Bills                       & 5.29\%                                       & \textbf{+53 bps}                            & 5.30\%                               & \textbf{+56 bps}                     & 5.18\%                              & \textbf{+67 bps}                    \\ \arrayrulecolor{light_grey}\hline
...
\end{tabular}
    ...
    \begin{axis}[
        ...
        ymin=3, ymax=6.32, %MAXRETURN HERE
...
{\color[HTML]{FFFFFF} \textbf{Current Principal}} & \multicolumn{2}{l!{\color{light_grey}\vrule}}{\cellcolor[HTML]{EFEFEF}\textbf{\$305.2 million}} \\
